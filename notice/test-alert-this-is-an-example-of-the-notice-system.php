...
<!--[if (gt IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <head>
    ...
    <title>Site Wide Notice: Test Alert! This is an example of the notice system. - TERMINALFOUR University</title>
      <!-- Inner page left nav -->
...
<!-- End Google Tag Manager -->
    ...
    <!-- og:description -->
    <!-- og:image -->
    <meta property="og:type" content="article" /><meta property="og:url" content="https://samplesite.terminalfour.com/notice/" /><meta property="og:title" content="Site Wide Notice" />
...
<div class="row"><div class="small-12 columns">
  <nav class="breadcrumbs">
	<ul><li><a href="/">Home</a></li><li><a href="/notice/">Site Wide Notice</a></li><li>Test Alert! This is an example of the notice system.</li></ul>
  </nav>
</div>
</div>
  <!-- ./breadcrumbs -->    
      ...
      <h1>Site Wide Notice</h1>

           <!-- end of SM header -->
<h3>Emergency Notice</h3>
<p>Emergency notices are used to let website visitors know of any emergencies currently in progress.</p>
<p>It is important that these notices are easy to add and that they do not require a full site publish. We have implemented this notice system to be as simple as possible in TERMINALFOUR.</p>
<p>We have defined a content type called "Emergency Notice". Simply adding and approving this content in a section witll trigger an auto-publish.<br>This content type has 3 elements.&nbsp;</p>
<ol>
<li><strong>Site Wide Banner</strong> – This is a plain text element and is for the text you want to appear in the banner at the top of every page of your site</li>
<li><strong>Description</strong> – This is a HTML element and is for the more detailed content on the page that the user will arrive when they click the banner (what you are reading now)</li>
<li><strong>Notice Type</strong> – This is a Select Box where you can choose the severity of your notice.</li>
</ol>
<p>The three notice types we have created for this demo are:</p>
<ul>
<li><strong>Emergency</strong>&nbsp;(Outputs as a red banner that cannot be dismissed)</li>
<li><strong>Warning</strong> (Outputs as an orange banner that can be dismissed)</li>
<li><strong>Notice</strong> (Outputs as a blue banner that can be dismissed)</li>
</ul>
<p>Dismissed notices will be hidden for 24 hours from the time the user dismisses them. We manage this through a cookie in which we save the content ID. If you need to update a notice and all users must see this notice even if they have dismissed an earlier version then you can just create a new piece of content. This ensures the notice has a new content ID and will be shown to the user.</p>
<p>There is no limit to the number of notices you can have&nbsp;on your site at the same time at any notice level.</p>
<h4>How it works</h4>
<p>When you save a Notice a JSON file is created that contains all the current active notices.</p>
<p>When a user visits a page some Javascript checks this JSON file to see if there are any live notices. If a notice is found in the JSON file we first check it's notice type. If the notice type is emergency then we show it on the screen. If the notice type is "warning" or "notice" then we check to see if the user has already dismissed this notice before we display it on the screen.</p>
<p>Every 10 seconds this script runs again. This means that a user does not need to re-load the webpage to see a new notice.</p>
<h4>Screen readers</h4>
<p>All modern screen readers including Apple's VoiceOver are supported with these notice. We use "aria-live" attributes to inform the screen reader of the severity of the notice. If an emergency notice is injected onto a page the screen reader will read this aloud immediately. For lower severity notices the screen reader will finish the block of text it is reading, wait for the user to be idle and then read the notice. More information on aria-live attributes can be found in the <a href="https://www.w3.org/TR/wai-aria/states_and_properties#aria-live">WAI-ARIA specification</a>.</p><!-- start of SM footer -->
  </div>
  ...
  <div class="small-12 medium-3 medium-pull-9 columns">
    <nav>
      <header>
    <div class="h4 side-nav-header"><a href="/notice/">Site Wide Notice</a></div>
      </header>
    <ul class="side-nav">
