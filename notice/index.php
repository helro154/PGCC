...
<!--[if (gt IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <head>
    ...
    <title>Site Wide Notice - TERMINALFOUR University</title>
      <!-- Inner page left nav -->
...
<div class="row"><div class="small-12 columns">
  <nav class="breadcrumbs">
	<ul><li><a href="/">Home</a></li><li><a href="/notice/">Site Wide Notice</a></li></ul>
  </nav>
</div>
</div>
  <!-- ./breadcrumbs -->    
      ...
      <h1>Site Wide Notice</h1>
           ...
           <!-- end of SM header -->
<p>
	<a href="/notice/test-alert-this-is-an-example-of-the-notice-system.php">Test Alert! This is an example of the notice system.</a>
</p>
<!-- start of SM footer -->
  </div>
