...
<!--[if (gt IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <head>
    ...
    <title>Homepage 2 - TERMINALFOUR University</title>
      <!-- Inner page left nav -->
...
<div class="row"><div class="small-12 columns">
  <nav class="breadcrumbs">
	<ul><li><a href="/">Home</a></li><li><a href="/assets/">Site Assets</a></li><li><a href="/assets/course-search-forms/">Course Search Forms</a></li><li><a href="/assets/course-search-forms/homepage-2/">Homepage 2</a></li></ul>
  </nav>
</div>
</div>
  <!-- ./breadcrumbs -->    
...
<fieldset><legend class="wai hidden">Choose the Course type</legend>
<input type="radio" name="courseType" value="Undergraduate" id="UG-CourseType"><label for="UG-CourseType">Undergraduate</label>
