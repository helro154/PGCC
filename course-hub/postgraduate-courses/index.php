...
<!--[if (gt IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <head>
    ...
    <title>Postgraduate Courses - TERMINALFOUR University</title>
      <!-- Inner page left nav -->
...
<!-- End Google Tag Manager -->
    ...
    <meta name="description" content="<strong>TERMINALFOUR</strong> is home to a large number of world-ranked researchers. This means that postgraduate students are assured of interacting with scholars who are internationally recognized experts in their field." /><!-- description -->
    <!-- keywords -->
    ...
    <meta property="og:description" content="<strong>TERMINALFOUR</strong> is home to a large number of world-ranked researchers. This means that postgraduate students are assured of interacting with scholars who are internationally recognized experts in their field." /><!-- og:description -->
    <!-- og:image -->
...
<div class="row"><div class="small-12 columns">
  <nav class="breadcrumbs">
	<ul><li><a href="/">Home</a></li><li><a href="/course-hub/">Course Hub</a></li><li><a href="/course-hub/postgraduate-courses/">Postgraduate Courses</a></li></ul>
  </nav>
</div>
</div>
  <!-- ./breadcrumbs -->    
...
<div class="general">
  ...
  <p class="intro"><strong>TERMINALFOUR</strong> is home to a large number of world-ranked researchers. This means that postgraduate students are assured of interacting with scholars who are internationally recognized experts in their field.</p>
  <div class="content"><p>Looking to enhance your career? Need the competitive edge? Join <strong>T4U</strong>, we offer intellectually stimulating research areas at the postgraduate level, excellent supervision and research support, as well as funding for meritorious students and those in financial need.</p>
<p>We have an exciting range of&nbsp;postgraduate courses&nbsp;that you can study full time, part time or online.</p></div>
</div><ul>
<li><a href="/course-hub/postgraduate-courses/ms-in-human-computer-interaction-hci/">M.S. in Human-Computer Interaction (HCI)</a> - MS-HCI</li><li><a href="/course-hub/postgraduate-courses/ms-in-computer-science/">M.S. in Computer Science</a> - MS-CS</li><li><a href="/course-hub/postgraduate-courses/march-professional-master-of-architecture/">M.Arch. Professional Master of Architecture</a> - M-Arch</li>
</ul>
<!-- start of SM footer -->
  </div>
