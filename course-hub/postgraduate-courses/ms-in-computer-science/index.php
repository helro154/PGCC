...
<!--[if (gt IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <head>
    ...
    <title>M.S. in Computer Science - TERMINALFOUR University</title>
      <!-- Inner page left nav -->
...
<div class="row"><div class="small-12 columns">
  <nav class="breadcrumbs">
	<ul><li><a href="/">Home</a></li><li><a href="/course-hub/">Course Hub</a></li><li><a href="/course-hub/postgraduate-courses/">Postgraduate Courses</a></li><li><a href="/course-hub/postgraduate-courses/ms-in-computer-science/">M.S. in Computer Science</a></li></ul>
  </nav>
</div>
</div>
  <!-- ./breadcrumbs -->    
...
<div class="row with-margin">
    <div class="small-12 columns">
        <div class="course-header">
            <img src="/media/sample-site/content-assets/global-content-assets/images/courses/motherboard-750.jpg" alt="Image of a CPU slot on a motherboard" >
            <h2 class="h1">M.S. in Computer Science</h2>
        </div>
    </div>
</div>
...
<div class="row course-info">
          ...
          <div class="small-12 medium-6 columns">
                <p><strong>Course Code:</strong> MS-CS</p>
          </div>
      ...
      <div class="small-12 medium-6 columns">
          ...
          <div class="small-12 medium-6 columns">
                <p><strong>Faculty:</strong> Engineering, Humanities & Sciences</p>
          </div>
      

    
          <div class="small-12 medium-6 columns">
                 <p><strong>Accreditation:</strong> MSc</p>
          </div>
     
    
          <div class="small-12 medium-6 columns">
                <p><strong>Course Duration:</strong> 2 Year</p>
          </div>
      
     
          <div class="small-12 medium-6 columns">
                <p><strong>Course Location:</strong> Seattle</p>
          </div>
      
     
          <div class="small-12 medium-6 columns">
                <p><strong>Starting Dates:</strong> 06 - June, 08 - August</p>
          </div>
      
     
          <div class="small-12 medium-6 columns">
                <p><strong>Contact email:</strong> rosejdavies@t4u.com</p>
          </div>
 ...
 <!-- ./side bar course info -->
  ...
  <div class="content"><p>T4U Open Day December 14th - sign up here&nbsp;<a href="/course-hub/">Admissions</a></p></div>
        ...
        <p>The students from M.S. in Computer Science will be demonstrating work from last years projects on November 23rd 2014.</p>
     ...
     <div class="course-page">
        ...
        <div class='add course_compare_btn view_saved_c_btn showAdd'>
            <a href='/course-hub/course-compare/?addCourse=363' class='save button course-363'><span class='fa fa-plus'></span>&nbsp; Save this course</a>
        </div>

        <div class='remove view_saved_c_btn course_compare_btn hideRemove'>
            <a href='/course-hub/course-compare/?removeCourse=363' class='save button course-363'><span class='fa fa-check'></span>&nbsp; Saved</a>
...
<p><strong>Course requirements:</strong>&nbsp;Graduate credit is awarded for courses numbered 5000 and above. The program of course work for a master’s degree must be approved by the student’s adviser, supervisory committee, or faculty representative of the academic unit. No more than 9 credits from a previous master’s degree program may apply toward a second master’s degree. These credits are applied only with the written approval of the Dean of the Graduate School.</p>
                    ...
                    <p>Minor work must be in an academic unit other than the major. If an academic unit contributes more than one course (as specified in the curriculum inventory and/or the Graduate Catalog) to the major, the student is not eligible to earn a minor from the contributing academic unit. If a minor is chosen, at least 6 credits of work are required in the minor field. Two 6-credit minors may be taken with the major academic unit’s permission. A 3.00 (truncated) GPA is required for minor credit.&nbsp;&nbsp;</p>
...
<p>This module is intended to provide a basic understanding of the operation of the hardware components of computer systems and networks, enabling students to evaluate hardware and perform dimensioning estimations. The role of the operating system is also covered, relating it to the facilities needed by users, administrators and programmers.</p>
<p><strong>Computational Intelligence</strong></p>
<p>This module will provide a theoretical and practical overview of computational intelligence. This inclues the most recent artificial intelligence methods and approaches such as evolutionary computation, artificial neural networks, fuzzy logic, artificial life and cognitive robotics.</p>
                    

                    
                    <p><strong>Databases</strong></p>
<p>To introduce students to the concepts and issues concerning multiuser, networked relational databases in a practical environment. To provide a solid foundation in SQL.</p>
                    
                    
                    <p><strong>Information Retrieval</strong></p>
<p>This module considers the organisation, storage and retrieval of unstructured information based on its content. World Wide Web search engines will be used extensively both as a source of material and for demonstration purposes. Additionally, current issues in the information industry are addressed.</p>
                    


                    <p><strong>Alternative Computing Paradigms</strong></p>
<p>This module provides students with an overview of a range of different paradigms for computing and computing theory.</p>
<p><strong>Embedded Systems</strong></p>
<p>Embedded Systems (very small programmable devices, the hidden computers which control everyday objects) are everywhere. The module makes use of industry standard development tools to design and build embedded systems, as well as to create the software to control them.</p>
<p><strong>Object-Oriented Software Engineering with Design Patterns<br></strong></p>
<p>This module aims to develop object-oriented software engineering, using a commonly-used language such as C++ or Java as the vehicle for implementation. It will also introduce issues such as progression from analysis to design and the use of design patterns to enhance software development.</p>
<p><strong>Cybercrime and Forensic Investigation<br></strong></p>
<p>This module considers issues relating to computer crime and abuse, including the common threats facing IT systems and the impacts that these have upon individuals and organisations. It also examines techniques that can be used to investigate a cybercrime incident.</p>
<p><strong>Computer Science Integrating Project</strong></p>
<p>This project provides an opportunity for students to draw together many of the threads of the Computer Science programme in preparation for the final year. Students work in teams to manage and complete a project for a given scenario. In addition, this module provides an opportunity to design and develop an application for a mobile device.</p>
<p><strong>IT Legislation and Ethics</strong></p>
<p>This module considers the wider issues facing the IT professional and develops an awareness of issues of legislation, ethics and professionalism that affect the industry</p>
<p>&nbsp;</p>
                </div>
            </dd>
            <!--
            ...
            <dd>
                ...
                <div id="tutors" class="content">
                       ...
                       <ul> <li><a href="/course-hub/tutors/alisha-m-morrison/">Alisha M. Morrison</a></li></ul>
...
<p><br>** These figures are averages and will vary from student to student. They are indirect costs not billed by the bursar.</p>
            ...
            <dd>
                ...
                <div id="related" class="content">
                       ...
                       <ul> <li><a href="/course-hub/postgraduate-courses/ms-in-human-computer-interaction-hci/">M.S. in Human-Computer Interaction (HCI)</a> - MS-HCI</li></ul>
