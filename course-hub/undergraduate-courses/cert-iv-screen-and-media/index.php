...
<!--[if (gt IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <head>
    ...
    <title>Cert IV Screen and Media - TERMINALFOUR University</title>
      <!-- Inner page left nav -->
...
<!-- End Google Tag Manager -->
    ...
    <meta name="description" content="The course structure below shows what you must do to complete this course, units/modules are arranged in groups and sometimes also in subgroups.
...
SubGroups 1
SubGroups 2" /><!-- description -->
    <!-- keywords -->
    
    <meta name="coursecode" content="19236" /><!-- course code -->
...
<div class="row"><div class="small-12 columns">
  <nav class="breadcrumbs">
	<ul><li><a href="/">Home</a></li><li><a href="/course-hub/">Course Hub</a></li><li><a href="/course-hub/undergraduate-courses/">Undergraduate Courses</a></li><li><a href="/course-hub/undergraduate-courses/cert-iv-screen-and-media/">Cert IV Screen and Media</a></li></ul>
  </nav>
</div>
</div>
  <!-- ./breadcrumbs -->    
      ...
      <h1>Cert IV Screen and Media</h1>
...
<div class="row with-margin">
    <div class="small-12 columns">
        <div class="course-header">
            <img src="/media/sample-site/content-assets/global-content-assets/images/courses/Screen-and-media.jpg" alt="Screen and Media" >
            <h2 class=
"h1">Cert IV Screen and Media</h2>
        </div>
    </div>
</div>
...
<div class="row course-info">
          ...
          <div class="small-12 medium-6 columns">
                                                                                                               <p><strong>Course Code:</strong> <span class="code">19236</span></p>
          </div>
      ...
      <div class="small-12 medium-6 columns">
          ...
          <div class="small-12 medium-6 columns">
                <p><strong>Faculty:</strong> <span class="faculty">College of Arts</span></p>
          </div>
          ...
          <div class="small-12 medium-6 columns">
                <p><strong>Course Contact:</strong> <span class="contact">Aileen Burdick</span></p>
          </div>
 ...
 <!-- ./side bar course info -->
     ...
     <div class="course-page">
	      ...
	      <div class='add course_compare_btn view_saved_c_btn showAdd'>
	          <a href='/course-hub/course-compare/?addCourse=936' class='save button course-936'><span class='fa fa-plus'></span>&nbsp; Save this course</a>
	      </div>

	      <div class='remove view_saved_c_btn course_compare_btn hideRemove'>
	          <a href='/course-hub/course-compare/?removeCourse=936' class='save button course-936'><span class='fa fa-check'></span>&nbsp; Saved</a>
        ...
        <div class="overview">
            <p>The course structure below shows what you must do to complete this course, units/modules are arranged in groups and sometimes also in subgroups.
<br />To achieve the Certificate IV in Screen & Media (CUF40107) a total of 8 units of competency must be completed:
<br />
<br />3 core units plus 5 elective units from within
<br />SubGroups 1
<br />SubGroups 2</p>
        </div>
  ...
  <a class="button applicationLink" href="http://ukcloud38-inbssbmachine.cloud.elluciandemo.com:9010/CLOUD38/bwkkspgr.showpage?page=ESC_PROGCAT_PRGREQ&pname=PPROGCODE&pvalue=19236&pname=TERM&pvalue=201601">Additional Course Information</a>
