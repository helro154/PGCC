...
<!--[if (gt IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <head>
    ...
    <title>Bachelor of Science in Environmental Science - TERMINALFOUR University</title>
      <!-- Inner page left nav -->
...
The programme is offered via lectures, tutorials, senminars, fled trips &amp; laboratory sessions across all three years of the programme. There is an emphasis on small group study, particularly with field work. Assessments may be in the form of written work, field course write-ups, laboratory reports, poster sessions, oral delivery, electronic exercises &amp; individual interview." /><!-- description -->
    ...
    <meta name="coursecode" content="BSC/ES" /><!-- course code -->
    <meta name="coursetype" content="Undergraduate" /><!-- course type -->
    <meta name="location" content="New York" /><!-- location -->
    <meta name="category" content="Biology" /><!-- category -->
    <meta name="courseaccreditation" content="Bachelor of Science" /><!-- course accreditation -->
    <!-- start date -->
    <!-- end date -->
...
<div class="row"><div class="small-12 columns">
  <nav class="breadcrumbs">
	<ul><li><a href="/">Home</a></li><li><a href="/course-hub/">Course Hub</a></li><li><a href="/course-hub/undergraduate-courses/">Undergraduate Courses</a></li><li><a href="/course-hub/undergraduate-courses/bachelor-of-science-in-environmental-science/">Bachelor of Science in Environmental Science</a></li></ul>
  </nav>
</div>
</div>
  <!-- ./breadcrumbs -->    
      ...
      <h1>Bachelor of Science in Environmental Science</h1>
...
<div class="row with-margin">
    <div class="small-12 columns">
        <div class="course-header">
            <img src="/media/sample-site/content-assets/global-content-assets/images/courses/environmentalscience.jpg" alt="Environmental Science" >
            <h2 class=
"h1">Bachelor of Science in Environmental Science</h2>
        </div>
    </div>
</div>
...
<div class="row course-info">
          ...
          <div class="small-12 medium-6 columns">
                                                                                                               <p><strong>Course Code:</strong> <span class="code">BSC/ES</span></p>
          </div>
      ...
      <div class="small-12 medium-6 columns">
          ...
          <div class="small-12 medium-6 columns">
                <p><strong>Department:</strong> <span class="dept">Biology</span></p>
          </div>
      
          
          <div class="small-12 medium-6 columns">
                <p><strong>Faculty:</strong> <span class="faculty">Faculty of Science</span></p>
          </div>
      

    
          <div class="small-12 medium-6 columns">
                 <p><strong>Accreditation:</strong> <span class="accreditation">Bachelor of Science</span></p>
          </div>
          ...
          <div class="small-12 medium-6 columns">
                <p><strong>Course Contact:</strong> <span class="contact">Cheryl McGahey and Tracy Brobyn</span></p>
          </div>
...
<div class="small-12 medium-6 columns">
                <p><strong>Max Transfer Credit:</strong> <span class="transfer_credit">120</span></p>
          </div>
<div class="small-12 medium-6 columns">
 ...
 <!-- ./side bar course info -->
     ...
     <div class="course-page">
	      ...
	      <div class='add course_compare_btn view_saved_c_btn showAdd'>
	          <a href='/course-hub/course-compare/?addCourse=969' class='save button course-969'><span class='fa fa-plus'></span>&nbsp; Save this course</a>
	      </div>

	      <div class='remove view_saved_c_btn course_compare_btn hideRemove'>
	          <a href='/course-hub/course-compare/?removeCourse=969' class='save button course-969'><span class='fa fa-check'></span>&nbsp; Saved</a>
        ...
        <div class="overview">
            <p>This long established and highly respected programme of study has strong links with the National Subject Centre for environmental science. Our flexible and interdisciplinary approach to teaching and research integrates physical, chemical, geological, biological and social sciences.&nbsp;&nbsp;We place particular importance on field work both in the UK and overseas through residential field courses.
<br />
<br />Other highlights of this programme include:
<br />
<br />Membership to the Institution of Environmental Science
<br />Affiliation with the National Marine Aquarium and the Eden Project
<br />International exchange programme with the USA, Canada and Europe
<br />Key focus is employability
<br />
<br />Professional accreditation
<br />This programme is recognised with the Institution of Environmental Sciences.
<br />
<br />Teaching and assessment
<br />The programme is offered via lectures, tutorials, senminars, fled trips & laboratory sessions across all three years of the programme. There is an emphasis on small group study, particularly with field work. Assessments may be in the form of written work, field course write-ups, laboratory reports, poster sessions, oral delivery, electronic exercises & individual interview.</p>
        </div>
  ...
  <a class="button applicationLink" href="http://ukcloud38-inbssbmachine.cloud.elluciandemo.com:9010/CLOUD38/bwkkspgr.showpage?page=ESC_PROGCAT_PRGREQ&pname=PPROGCODE&pvalue=BSC/ES&pname=TERM&pvalue=201601">Additional Course Information</a>
