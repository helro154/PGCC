...
<!--[if (gt IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <head>
    ...
    <title>Math - TERMINALFOUR University</title>
      <!-- Inner page left nav -->
...
<div class="row"><div class="small-12 columns">
  <nav class="breadcrumbs">
	<ul><li><a href="/">Home</a></li><li><a href="/course-hub/">Course Hub</a></li><li><a href="/course-hub/undergraduate-courses/">Undergraduate Courses</a></li><li><a href="/course-hub/undergraduate-courses/math/">Math</a></li></ul>
  </nav>
</div>
</div>
  <!-- ./breadcrumbs -->    
...
<div class="row course-info">
          ...
          <div class="small-12 medium-6 columns">
                                                                                                               <p><strong>Course Code:</strong> <span class="code">MA499</span></p>
          </div>
      ...
      <div class="small-12 medium-6 columns">
          ...
          <div class="small-12 medium-6 columns">
                <p><strong>Department:</strong> <span class="dept">Mathematics</span></p>
          </div>
          ...
          <div class="small-12 medium-6 columns">
                <p><strong>Course Location:</strong> <span class="location">Los Angeles</span></p>
          </div>
      
     
          <div class="small-12 medium-6 columns">
                <p><strong>Starting Dates:</strong> <span class="start_dates">September</span></p>
          </div>
      
     
          <div class="small-12 medium-6 columns">
                <p><strong>Course Contact:</strong> <span class="contact">mathematics@t4u.com</span></p>
          </div>
 ...
 <!-- ./side bar course info -->
     ...
     <div class="course-page">
	      ...
	      <div class='add course_compare_btn view_saved_c_btn showAdd'>
	          <a href='/course-hub/course-compare/?addCourse=295' class='save button course-295'><span class='fa fa-plus'></span>&nbsp; Save this course</a>
	      </div>

	      <div class='remove view_saved_c_btn course_compare_btn hideRemove'>
	          <a href='/course-hub/course-compare/?removeCourse=295' class='save button course-295'><span class='fa fa-check'></span>&nbsp; Saved</a>
        ...
        <div class="overview">
            <p>The mathematics bachelor of science degree program provides training in the theory and techniques of algebra, analysis, and other fields as a basis for further work in pure and applied mathematics and for graduate studies. Mathematics BS students may choose to take a second major in secondary school teaching to prepare for a career as a teacher.</p>
        </div>
    ...
    <div class="course_details_accordionentry_reqscheduletutorstuitionrelated_courses">
        ...
        <dl class="accordion" data-accordion >
            ...
            <dd>
                ...
                <div id="requirements" class="content">
                    <p>Formal admission to the major requires a cumulative grade point average of 2.00 (on a 4.00 scale) and departmental approval.&nbsp;</p>
<ul>
<li>A total of 120 credit hours&nbsp;</li>
<li>6 credit hours of college writing&nbsp;</li>
<li>3 credit hours of college mathematics or the equivalent by examination&nbsp;</li>
</ul>
                </div>
            </dd>
            <dd>
                ...
                <div id="schedule" class="content">
                    <ul>
<li>STAT-203 Basic Statistics with Calculus (4) or STAT-202 Basic Statistics (4) (with permission of department)</li>
<li>CSC-280 Introduction to Computer Science I (4)&nbsp;</li>
<li>MATH-221 Calculus I (4)&nbsp;</li>
<li>MATH-222 Calculus II (4)&nbsp;</li>
<li>MATH-313 Calculus III (4)&nbsp;</li>
<li>MATH-310 Linear Algebra (3)&nbsp;</li>
<li>MATH-321 Differential Equations (3)</li>
<li>MATH-503 Foundations of Mathematics (3)</li>
<li>MATH-512 Introduction to Modern Algebra (3)&nbsp;</li>
<li>MATH-520 Introduction to Analysis (3)&nbsp;</li>
<li>MATH-550 Complex Analysis (3)&nbsp;</li>
<li>One course from each of the following groups:</li>
</ul>
<h4>Group One</h4>
<ul>
<li>MATH-521 Measure and Integration Theory (3)</li>
<li>MATH-504 Advanced Calculus of Several Variables (3)</li>
<li>MATH-510 Geometry (3)</li>
<li>MATH-540 Topology (3)</li>
<li>MATH-580 Topics in Mathematics</li>
</ul>
<h4>Group Two</h4>
<ul>
<li>MATH-505 Mathematical Logic (3)</li>
<li>MATH-513 Rings and fields (3)</li>
<li>MATH-515 Number Theory (3)</li>
<li>MATH-580 Topics in Mathematics(3)</li>
</ul>
<h4>Group Three</h4>
<ul>
<li>MATH-501 Probability (3)</li>
<li>MATH-551 Partial Differential&nbsp;Equations&nbsp;(3)</li>
<li>MATH-560 Numerical Analysis:&nbsp;Basic&nbsp;Problems&nbsp;(3)</li>
<li>MATH-570 History of Mathematics (3)</li>
<li>MATH-580 Topics in Mathematics(3) With the department's approval.</li>
</ul>
                </div>
            </dd>
            <!--
            ...
            <dd>
                ...
                <div id="tutors" class="content">
                    <ul>
<li>William C. Gallegos</li>
<li>Terry R. McKinney</li>
<li>Sherry F. Kuykendall</li>
<li>Wallace C. Jones</li>
<li>Lula S. Kennedy</li>
</ul>
                </div>
            </dd>
            <!--
...
<p>*Students are also required to register for a minimum of 2 credit hours during the summer session. Full-time enrollment is considered 3 credit hours. Summer 2015 tuition rates are $430 per credit hour (in-state students) and $1,100 per credit hour (out-of-state students) plus an $80 comprehensive/registration fee.</p>
            ...
            <dd>
                ...
                <div id="related" class="content">
                    <ul>
<li><a href="/course-hub/undergraduate-courses/software-engineering/">Software Engineering</a></li>
</ul>
                </div>
            </dd>
            <!--
