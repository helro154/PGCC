...
<!--[if (gt IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <head>
    ...
    <title>Certificate IV in Business - TERMINALFOUR University</title>
      <!-- Inner page left nav -->
...
<!-- End Google Tag Manager -->
    ...
    <meta name="description" content="No course overview supplied" /><!-- description -->
    <!-- keywords -->
    
    <meta name="coursecode" content="BSB40212" /><!-- course code -->
...
<div class="row"><div class="small-12 columns">
  <nav class="breadcrumbs">
	<ul><li><a href="/">Home</a></li><li><a href="/course-hub/">Course Hub</a></li><li><a href="/course-hub/undergraduate-courses/">Undergraduate Courses</a></li><li><a href="/course-hub/undergraduate-courses/certificate-iv-in-business/">Certificate IV in Business</a></li></ul>
  </nav>
</div>
</div>
  <!-- ./breadcrumbs -->    
      ...
      <h1>Certificate IV in Business</h1>
...
<div class="row with-margin">
    <div class="small-12 columns">
        <div class="course-header">
            <img src="/media/sample-site/content-assets/global-content-assets/images/courses/business-studies.jpg" alt="Business Studies" >
            <h2 class=
"h1">Certificate IV in Business</h2>
        </div>
    </div>
</div>
...
<div class="row course-info">
          ...
          <div class="small-12 medium-6 columns">
                                                                                                               <p><strong>Course Code:</strong> <span class="code">BSB40212</span></p>
          </div>
      ...
      <div class="small-12 medium-6 columns">
          ...
          <div class="small-12 medium-6 columns">
                <p><strong>Course Contact:</strong> <span class="contact">N/A</span></p>
          </div>
 ...
 <!-- ./side bar course info -->
     ...
     <div class="course-page">
	      ...
	      <div class='add course_compare_btn view_saved_c_btn showAdd'>
	          <a href='/course-hub/course-compare/?addCourse=966' class='save button course-966'><span class='fa fa-plus'></span>&nbsp; Save this course</a>
	      </div>

	      <div class='remove view_saved_c_btn course_compare_btn hideRemove'>
	          <a href='/course-hub/course-compare/?removeCourse=966' class='save button course-966'><span class='fa fa-check'></span>&nbsp; Saved</a>
        ...
        <div class="overview">
            <p>No course overview supplied</p>
        </div>
  ...
  <a class="button applicationLink" href="http://ukcloud38-inbssbmachine.cloud.elluciandemo.com:9010/CLOUD38/bwkkspgr.showpage?page=ESC_PROGCAT_PRGREQ&pname=PPROGCODE&pvalue=BSB40212&pname=TERM&pvalue=201601">Additional Course Information</a>
