...
<!--[if (gt IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <head>
    ...
    <title>Chemistry - TERMINALFOUR University</title>
      <!-- Inner page left nav -->
...
<!-- End Google Tag Manager -->
    ...
    <meta name="description" content="The major in chemistry provides training for students planning careers in the chemical sciences and also for those whose interests lie in biology, medicine, earth sciences, secondary education, business, and law. The curriculum of the Department is designed to satisfy the diverse needs of these students. Advanced coursework and educational activities outside the traditional classroom, such as independent research provide students the opportunity to conduct individual research projects or participate as member of a research team. " /><!-- description -->
    <!-- keywords -->
    
    <meta name="coursecode" content="CY481" /><!-- course code -->
    <meta name="coursetype" content="Undergraduate" /><!-- course type -->
    <meta name="location" content="New York" /><!-- location -->
    <meta name="category" content="Biology, Chemistry, Physics" /><!-- category -->
    <meta name="courseaccreditation" content="BSc" /><!-- course accreditation -->
    <!-- start date -->
    <!-- end date -->
...
<div class="row"><div class="small-12 columns">
  <nav class="breadcrumbs">
	<ul><li><a href="/">Home</a></li><li><a href="/course-hub/">Course Hub</a></li><li><a href="/course-hub/undergraduate-courses/">Undergraduate Courses</a></li><li><a href="/course-hub/undergraduate-courses/chemistry/">Chemistry</a></li></ul>
  </nav>
</div>
</div>
  <!-- ./breadcrumbs -->    
...
<div class="row with-margin">
    <div class="small-12 columns">
        <div class="course-header">
            <img src="/media/sample-site/content-assets/global-content-assets/images/courses/forensic-science.jpg" alt="Close up of a microscope" >
            <h2 class=
"h1">Chemistry</h2>
        </div>
    </div>
...
<div class="row course-info">
          ...
          <div class="small-12 medium-6 columns">
                                                                                                               <p><strong>Course Code:</strong> <span class="code">CY481</span></p>
          </div>
     

     
      <div class="small-12 medium-6 columns">
                <p><strong>Course Type:</strong> <span class="type">Undergraduate</span></p>
      </div>
     
          
          <div class="small-12 medium-6 columns">
                <p><strong>Department:</strong> <span class="dept">Biology, Chemistry, Physics</span></p>
          </div>
      
          
          <div class="small-12 medium-6 columns">
                <p><strong>Faculty:</strong> <span class="faculty">Humanities & Sciences</span></p>
          </div>
      

    
          <div class="small-12 medium-6 columns">
                 <p><strong>Accreditation:</strong> <span class="accreditation">BSc</span></p>
          </div>
     
    
          <div class="small-12 medium-6 columns">
                <p><strong>Course Duration:</strong> <span class="duration">4 Year</span></p>
          </div>
      
     
          <div class="small-12 medium-6 columns">
                <p><strong>Course Location:</strong> <span class="location">New York</span></p>
          </div>
      
     
          <div class="small-12 medium-6 columns">
                <p><strong>Starting Dates:</strong> <span class="start_dates">June</span></p>
          </div>
      
     
          <div class="small-12 medium-6 columns">
                <p><strong>Course Contact:</strong> <span class="contact">chemistry@t4u.com</span></p>
          </div>
 ...
 <!-- ./side bar course info -->
     ...
     <div class="course-page">
	      ...
	      <div class='add course_compare_btn view_saved_c_btn showAdd'>
	          <a href='/course-hub/course-compare/?addCourse=291' class='save button course-291'><span class='fa fa-plus'></span>&nbsp; Save this course</a>
	      </div>

	      <div class='remove view_saved_c_btn course_compare_btn hideRemove'>
	          <a href='/course-hub/course-compare/?removeCourse=291' class='save button course-291'><span class='fa fa-check'></span>&nbsp; Saved</a>
        ...
        <div class="overview">
            <p>The major in chemistry provides training for students planning careers in the chemical sciences and also for those whose interests lie in biology, medicine, earth sciences, secondary education, business, and law. The curriculum of the Department is designed to satisfy the diverse needs of these students. Advanced coursework and educational activities outside the traditional classroom, such as independent research provide students the opportunity to conduct individual research projects or participate as member of a research team. </p>
        </div>
      
              <!-- Application Link -->
        
                        <div>
                            <a class="button applicationLink" href="/">Application Link</a>
    ...
    <div class="course_details_accordionentry_reqscheduletutorslearning_outcomestuitionrelated_courses">
      <div class='course-home-expand'>
        ...
        <dl class="accordion" data-accordion >
          	<dt class="hidden">Course Details</dt>
          	<dd class="hidden"></dd>
            <dd>
                <a href="#requirements">Entry Requirements</a>
                <div id="requirements" class="content">
                    <ul>
<li>Conditional admission may be possible with less than a 3.0 GPA</li>
<li>A minimum of 18 months of industry experience</li>
</ul>
                </div>
            </dd>
            <dd>
...
<div><strong>CHEM-310:</strong>&nbsp;<strong>Organic Chemistry I (3)</strong></div>
<p>Systematic treatment of hydrocarbons, alkyl halides, alcohols, carbonyl compounds, acids, and their derivatives. Ionic and free radical reactions and stereochemistry. Usually offered every fall. Prerequisite: CHEM-210. Must be taken concurrently with CHEM-312.</p>
<div><strong>CHEM-312:</strong>&nbsp;<strong>Organic Chemistry I Laboratory (1)</strong></div>
<p>Laboratory theory and practice in synthesis, separation, and purification of organic compounds. Introduction to separation techniques including thin-layer, column, and gas chromatography. Usually offered every fall. Prerequisite: concurrent registration in CHEM-310.</p>
<div><strong>CHEM-320:</strong>&nbsp;<strong>Organic Chemistry II (3)</strong></div>
<p>Aliphatic and aromatic compounds and electrophilic substitution; spectral methods; and nitrogen compounds and their derivatives. Introduction to polyfunctional compounds including amino acids, carbohydrates, lipids, and nucleic acids. Usually offered every spring. Prerequisite: CHEM-310; must be taken concurrently with CHEM-322.</p>
<div><strong>CHEM-322:</strong>&nbsp;<strong>Organic Chemistry II Laboratory (1)</strong></div>
<p>Multistep syntheses; synthesis of polyfunctional compounds; introduction to infrared and nuclear magnetic resonance spectra; qualitative organic analysis. Usually offered every spring. Prerequisite: must be taken concurrently with CHEM-320.</p>
<div><strong>CHEM-330:</strong>&nbsp;<strong>Environmental Chemistry (3)</strong></div>
<p>This course emphasizes that all parts of the environment are made up of chemicals, and that natural processes occurring in the environment all involve chemical reactions. As part of a description of the chemistry of the lithosphere, hydrosphere, and atmosphere, the composition of an unpolluted environment is presented, as well as techniques used by the EPA to measure pollutants. Prerequisite: CHEM-110.</p>
<div><strong>CHEM-401:</strong>&nbsp;<strong>Geology (3)</strong></div>
...
<div><strong>CHEM-410:</strong>&nbsp;<strong>Biophysical Chemistry (3)</strong></div>
<p>This physical chemistry course provides an introduction to quantum mechanics, statistical mechanics, thermodynamics, and kinetics applied to biological systems by using examples from the life sciences. Usually offered alternate falls. Prerequisite: CHEM-210, MATH-221.</p>
<div><strong>CHEM-411:</strong>&nbsp;<strong>Biophysical Chemistry Laboratory (1)</strong></div>
<p>Experiments illustrate practical applications of physical chemistry to biochemical and biological systems. Usually offered alternate falls. Prerequisite: must be taken concurrently with CHEM-410.</p>
<div><strong>CHEM-490:</strong>&nbsp;<strong>Independent Study Project in Chemistry (1-6)</strong></div>
<p>Prerequisite: permission of instructor and department chair.</p>
<div><strong>CHEM-491:</strong>&nbsp;<strong>Internship (1-6)</strong></div>
<p>Prerequisite: permission of instructor and department chair.</p>
                </div>
            </dd>
            <!--
            ...
            <dd>
                ...
                <div id="tutors" class="content">
                    <ul>
<li>Arlene P. George</li>
<li>Kim M. Davis</li>
<li>Milton M. Tripp</li>
</ul>
                </div>
            </dd>
            <!--
            ...
            <dd>
                ...
                <div id="outcomes" class="content">
                    <ul>
<li>Graduates will be able to master a broad set of chemical knowledge concerning the fundamentals in the basic areas of the discipline (organic, inorganic, analytical, physical and biological chemistry).</li>
<li>Graduates will be able to solve problems competently by identifying the essential parts of a problem and formulating a strategy for solving the problem. They will be able to rationally estimate the solution to a problem, apply appropriate techniques to arrive at a solution, test the correctness of the solution, and interpret their results.</li>
<li>Graduates will be able to use computers in data acquisition and processing and use available software as a tool in data analysis.</li>
<li>Graduates will be able to use modern library search tools to locate and retrieve scientific information about a topic, chemical, chemical technique, or an issue relating to chemistry.</li>
</ul>
                </div>
            </dd>
            <!--
            ...
            <dd>
                ...
                <div id="tuition" class="content">
                    <p>The cost of full-time study (9 or more credit hours)&nbsp;for Academic Year&nbsp;2014-2015 is:</p>
<ul>
<li>$12,500* (In-State)</li>
<li>$28,000* (Out-of-State)&nbsp;</li>
</ul>
<p>*Students are also required to register for a minimum of 2 credit hours during the summer session. Full-time enrollment is considered 3 credit hours. Summer 2015 tuition rates are $430 per credit hour (in-state students) and $1,100 per credit hour (out-of-state students) plus an $80 comprehensive/registration fee.</p>
                </div>
            </dd>
            <!--
            -->
            <dd>
                ...
                <div id="related" class="content">
                    <ul>
<li><a href="/course-hub/undergraduate-courses/marine-science/">Marine Science</a></li>
<li><a href="/course-hub/undergraduate-courses/earth-systems/">Earth Systems</a></li>
</ul>
                </div>
            </dd>
            <!--
...
<script type="text/javascript" src="/media/sample-site/site-assets/javascript/course-compare.js"></script> <!-- Course compare JS -->
<script>
