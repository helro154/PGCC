...
<!--[if (gt IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <head>
    ...
    <title>Cert IV Aeroskills(Avionics) - TERMINALFOUR University</title>
      <!-- Inner page left nav -->
...
<!-- End Google Tag Manager -->
    ...
    <meta name="coursecode" content="AASAV211" /><!-- course code -->
...
<div class="row"><div class="small-12 columns">
  <nav class="breadcrumbs">
	<ul><li><a href="/">Home</a></li><li><a href="/course-hub/">Course Hub</a></li><li><a href="/course-hub/undergraduate-courses/">Undergraduate Courses</a></li><li><a href="/course-hub/undergraduate-courses/cert-iv-aeroskillsavionics/">Cert IV Aeroskills(Avionics)</a></li></ul>
  </nav>
</div>
</div>
  <!-- ./breadcrumbs -->    
      ...
      <h1>Cert IV Aeroskills(Avionics)</h1>
...
<div class="row with-margin">
    <div class="small-12 columns">
        <div class="course-header">
            <img src="/media/sample-site/content-assets/global-content-assets/images/courses/aeroskills.jpg" alt="Aeroskills Avionics" >
            <h2 class=
"h1">Cert IV Aeroskills (Avionics)</h2>
        </div>
    </div>
</div>
...
<div class="row course-info">
          ...
          <div class="small-12 medium-6 columns">
                                                                                                               <p><strong>Course Code:</strong> <span class="code">AASAV211</span></p>
          </div>
      ...
      <div class="small-12 medium-6 columns">
          ...
          <div class="small-12 medium-6 columns">
                <p><strong>Faculty:</strong> <span class="faculty">Aviation, Eng & Security</span></p>
          </div>
          ...
          <div class="small-12 medium-6 columns">
                <p><strong>Course Duration:</strong> <span class="duration">2 Year</span></p>
          </div>
  	 ...
  	 <div class="small-12 medium-6 columns">
                <p><strong>Credit Requirement:</strong> <span class="credit_rqt">900</span></p>
          </div> 
<div class="small-12 medium-6 columns">
 ...
 <!-- ./side bar course info -->
     ...
     <div class="course-page">
	      ...
	      <div class='add course_compare_btn view_saved_c_btn showAdd'>
	          <a href='/course-hub/course-compare/?addCourse=975' class='save button course-975'><span class='fa fa-plus'></span>&nbsp; Save this course</a>
	      </div>

	      <div class='remove view_saved_c_btn course_compare_btn hideRemove'>
	          <a href='/course-hub/course-compare/?removeCourse=975' class='save button course-975'><span class='fa fa-check'></span>&nbsp; Saved</a>
  ...
  <a class="button applicationLink" href="http://ukcloud38-inbssbmachine.cloud.elluciandemo.com:9010/CLOUD38/bwkkspgr.showpage?page=ESC_PROGCAT_PRGREQ&pname=PPROGCODE&pvalue=MEA40611&pname=TERM&pvalue=201601">Additional Course Information</a>
