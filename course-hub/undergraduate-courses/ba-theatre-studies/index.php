...
<!--[if (gt IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <head>
    ...
    <title>BA Theatre Studies - TERMINALFOUR University</title>
      <!-- Inner page left nav -->
...
<!-- End Google Tag Manager -->
    ...
    <meta name="description" content="Students will complete 3 years of full time study earning 120 credits each year for a total of 360 credits. A maximum of 120 credits can be transferred from other institutions subject to agreement by the Faculty of Arts.

Programme Co-ordinator: Dr Tracy Brobyn 
External Examiner: Dr Seamus Connor" /><!-- description -->
    <!-- keywords -->
    
    <meta name="coursecode" content="BA/THS" /><!-- course code -->
...
<div class="row"><div class="small-12 columns">
  <nav class="breadcrumbs">
	<ul><li><a href="/">Home</a></li><li><a href="/course-hub/">Course Hub</a></li><li><a href="/course-hub/undergraduate-courses/">Undergraduate Courses</a></li><li><a href="/course-hub/undergraduate-courses/ba-theatre-studies/">BA Theatre Studies</a></li></ul>
  </nav>
</div>
</div>
  <!-- ./breadcrumbs -->    
...
<div class="row with-margin">
    <div class="small-12 columns">
        <div class="course-header">
            <img src="/media/sample-site/content-assets/global-content-assets/images/courses/theatre-studies.jpg" alt="Theatre Studies" >
            <h2 class=
"h1">BA Theatre Studies</h2>
        </div>
    </div>
</div>
...
<div class="row course-info">
          ...
          <div class="small-12 medium-6 columns">
                                                                                                               <p><strong>Course Code:</strong> <span class="code">BA/THS</span></p>
          </div>
 ...
 <!-- ./side bar course info -->
     ...
     <div class="course-page">
	      ...
	      <div class='add course_compare_btn view_saved_c_btn showAdd'>
	          <a href='/course-hub/course-compare/?addCourse=963' class='save button course-963'><span class='fa fa-plus'></span>&nbsp; Save this course</a>
	      </div>

	      <div class='remove view_saved_c_btn course_compare_btn hideRemove'>
	          <a href='/course-hub/course-compare/?removeCourse=963' class='save button course-963'><span class='fa fa-check'></span>&nbsp; Saved</a>
        ...
        <div class="overview">
            <p>Students will complete 3 years of full time study earning 120 credits each year for a total of 360 credits. A maximum of 120 credits can be transferred from other institutions subject to agreement by the Faculty of Arts.
<br />
<br />Programme Co-ordinator: Dr Tracy Brobyn 
<br />External Examiner: Dr Seamus Connor</p>
        </div>
  ...
  <a class="button applicationLink" href="http://ukcloud38-inbssbmachine.cloud.elluciandemo.com:9010/CLOUD38/bwkkspgr.showpage?page=ESC_PROGCAT_PRGREQ&pname=PPROGCODE&pvalue=BA/THS&pname=TERM&pvalue=201601">Additional Course Information</a>
