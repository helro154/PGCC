...
<!--[if (gt IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <head>
    ...
    <title>Marine Science - TERMINALFOUR University</title>
      <!-- Inner page left nav -->
...
<div class="row"><div class="small-12 columns">
  <nav class="breadcrumbs">
	<ul><li><a href="/">Home</a></li><li><a href="/course-hub/">Course Hub</a></li><li><a href="/course-hub/undergraduate-courses/">Undergraduate Courses</a></li><li><a href="/course-hub/undergraduate-courses/marine-science/">Marine Science</a></li></ul>
  </nav>
</div>
</div>
  <!-- ./breadcrumbs -->    
...
<div class="row with-margin">
    <div class="small-12 columns">
        <div class="course-header">
            <img src="/media/sample-site/content-assets/global-content-assets/images/courses/music-production.jpg" alt="Person moving levels on a mixing desk" >
            <h2 class=
"h1">Marine Science</h2>
        </div>
    </div>
</div>
...
<div class="row course-info">
          ...
          <div class="small-12 medium-6 columns">
                                                                                                               <p><strong>Course Code:</strong> <span class="code">MS100</span></p>
          </div>
      ...
      <div class="small-12 medium-6 columns">
          ...
          <div class="small-12 medium-6 columns">
                <p><strong>Faculty:</strong> <span class="faculty">Earth Sciences</span></p>
          </div>
          ...
          <div class="small-12 medium-6 columns">
                <p><strong>Course Location:</strong> <span class="location">Seattle</span></p>
          </div>
      
     
          <div class="small-12 medium-6 columns">
                <p><strong>Starting Dates:</strong> <span class="start_dates">April, September</span></p>
          </div>
      
     
          <div class="small-12 medium-6 columns">
                <p><strong>Course Contact:</strong> <span class="contact">marine-science@t4u.com</span></p>
          </div>
 ...
 <!-- ./side bar course info -->
     ...
     <div class="course-page">
	      ...
	      <div class='add course_compare_btn view_saved_c_btn showAdd'>
	          <a href='/course-hub/course-compare/?addCourse=282' class='save button course-282'><span class='fa fa-plus'></span>&nbsp; Save this course</a>
	      </div>

	      <div class='remove view_saved_c_btn course_compare_btn hideRemove'>
	          <a href='/course-hub/course-compare/?removeCourse=282' class='save button course-282'><span class='fa fa-check'></span>&nbsp; Saved</a>
        ...
        <div class="overview">
            <p>Marine Science encompasses the study of marine life and environments, how they are formed and evolve, and how they are affected by human activity. Topics covered in this course include marine biology, earth science, chemistry and experimental physics, mathematics, statistics, oceanography, meteorology, botany, geology and microbiology.</p>
        </div>
        ...
        <dl class="accordion" data-accordion >
            ...
            <dd>
                ...
                <div id="requirements" class="content">
                    <p>The Marine Science major provides a strong foundation in science and math via eight required related courses in chemistry (2), biology (2), physics (1), calculus (2) and statistics (1). All students take Introductory Oceanography (CAS ES 144), three "marine breadth" courses, and the Marine Semester. For the Marine Semester, students choose four courses from among approximately 12 diverse course offerings. A grade of C or higher is required in all of the aforementioned courses to receive credit in the major. All courses are 4 credit hours.</p>
                </div>
            </dd>
            <dd>
...
<ul>
<li>Biology</li>
<li>Introduction to Earth and Ocean Sciences</li>
...
<ul>
<li>Introduction to Earth and Ocean Sciences</li>
<li>One of: Sediments and the Biosphere or Applied Statistics</li>
</ul>
<p>Plus two of the following:</p>
<ul>
<li>Botany</li>
<li>Mathematics</li>
<li>Applied Mathematics</li>
<li>Microbiology</li>
<li>Applied Mathematical Science</li>
<li>Zoology</li>
</ul>
<h4>Year 3</h4>
<ul>
<li>Introduction to Marine Ecology</li>
<li>Marine Geoscience</li>
</ul>
<p>Plus one of the following:</p>
<ul>
<li>Botany</li>
...
<h4>Year 4</h4>
<ul>
<li>Advanced Topics in Marine Science</li>
</ul>
<p>Plus one of the following:</p>
<ul>
<li>Marine Microbial Processes</li>
<li>Marine Zoology</li>
<li>Marine Plant Science</li>
...
<li>Physical Oceanography</li>
            ...
            <dd>
                ...
                <div id="tutors" class="content">
                    <ul>
<li>Stephen L. Newman</li>
<li>William T. Roy</li>
<li>Eunice W. Andrews</li>
</ul>
                </div>
            </dd>
            <!--
            ...
            <dd>
                ...
                <div id="outcomes" class="content">
                    <ul>
<li>Fundamental principles in marine science and oceanography, including (a) principles of atmospheric sciences, biological, chemical, geological and physical oceanography; (b) the interconnectedness of the atmosphere, biosphere, geosphere and hydrosphere; and (c) how human activities affect these connections.</li>
<li>The scientific method, including formulation of hypotheses, the use of varied approaches (experimental and observational) for testing hypotheses, appropriate interpretation of data encountered in class, lab, or the scientific literature.</li>
<li>Function successfully in laboratory and field settings, including use of basic equipment and techniques, and putting into practice the basic steps of the research process.</li>
<li>Employ the scientific method using real-world data, including formulation of hypotheses, the use of varied approaches (experimental and observational) for testing hypotheses, and appropriate interpretation of data encountered in class, lab, and the scientific literature.</li>
<li>Conduct literature reviews to obtain scientific information, including accessing all forms of scientific literature to investigate topics, critiquing sources, and organizing information in a scientifically meaningful way.</li>
<li>Synthesize a cogent argument in the language of science, including written and oral communication skills, and presentation of results using graphs and equations.</li>
</ul>
                </div>
            </dd>
            <!--
