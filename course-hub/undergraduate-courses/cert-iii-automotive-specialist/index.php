...
<!--[if (gt IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <head>
    ...
    <title>Cert III Automotive Specialist - TERMINALFOUR University</title>
      <!-- Inner page left nav -->
...
<!-- End Google Tag Manager -->
    ...
    <meta name="description" content="This qualification covers the skills and knowledge required to undertake specialist service and repair work on vehicles within the automotive service and repair sector. It is suitable for entry into the automotive specialist service and repair sector.
...
Application
This qualification is suitable for an Australian Apprenticeship pathway." /><!-- description -->
    <!-- keywords -->
    
    <meta name="coursecode" content="AUR30605" /><!-- course code -->
...
<div class="row"><div class="small-12 columns">
  <nav class="breadcrumbs">
	<ul><li><a href="/">Home</a></li><li><a href="/course-hub/">Course Hub</a></li><li><a href="/course-hub/undergraduate-courses/">Undergraduate Courses</a></li><li><a href="/course-hub/undergraduate-courses/cert-iii-automotive-specialist/">Cert III Automotive Specialist</a></li></ul>
  </nav>
</div>
</div>
  <!-- ./breadcrumbs -->    
      ...
      <h1>Cert III Automotive Specialist</h1>
...
<div class="row with-margin">
    <div class="small-12 columns">
        <div class="course-header">
            <img src="/media/sample-site/content-assets/global-content-assets/images/courses/auto-mech.jpg" alt="Auto Mech Tech" >
            <h2 class=
"h1">Cert III Automotive Specialist</h2>
        </div>
    </div>
</div>
...
<div class="row course-info">
          ...
          <div class="small-12 medium-6 columns">
                                                                                                               <p><strong>Course Code:</strong> <span class="code">AUR30605</span></p>
          </div>
 ...
 <!-- ./side bar course info -->
     ...
     <div class="course-page">
	      ...
	      <div class='add course_compare_btn view_saved_c_btn showAdd'>
	          <a href='/course-hub/course-compare/?addCourse=956' class='save button course-956'><span class='fa fa-plus'></span>&nbsp; Save this course</a>
	      </div>

	      <div class='remove view_saved_c_btn course_compare_btn hideRemove'>
	          <a href='/course-hub/course-compare/?removeCourse=956' class='save button course-956'><span class='fa fa-check'></span>&nbsp; Saved</a>
        ...
        <div class="overview">
            <p>This qualification covers the skills and knowledge required to undertake specialist service and repair work on vehicles within the automotive service and repair sector. It is suitable for entry into the automotive specialist service and repair sector.
<br />
<br />Job roles /employment outcomes
<br />The Certificate III in Automotive Specialist is intended to prepare new employees or recognise and develop existing workers who service and repair specialist systems and components of cars and other vehicles.
<br />
<br />Employment outcomes targeted by this qualification include:
<br />automotive mechanics.
<br />
<br />Application
<br />This qualification is suitable for an Australian Apprenticeship pathway.</p>
        </div>
  ...
  <a class="button applicationLink" href="http://ukcloud38-inbssbmachine.cloud.elluciandemo.com:9010/CLOUD38/bwkkspgr.showpage?page=ESC_PROGCAT_PRGREQ&pname=PPROGCODE&pvalue=AUR30605&pname=TERM&pvalue=201601">Additional Course Information</a>
