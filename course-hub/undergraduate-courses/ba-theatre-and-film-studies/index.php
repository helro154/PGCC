...
<!--[if (gt IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <head>
    ...
    <title>BA Theatre and Film Studies - TERMINALFOUR University</title>
      <!-- Inner page left nav -->
...
<div class="row"><div class="small-12 columns">
  <nav class="breadcrumbs">
	<ul><li><a href="/">Home</a></li><li><a href="/course-hub/">Course Hub</a></li><li><a href="/course-hub/undergraduate-courses/">Undergraduate Courses</a></li><li><a href="/course-hub/undergraduate-courses/ba-theatre-and-film-studies/">BA Theatre and Film Studies</a></li></ul>
  </nav>
</div>
</div>
  <!-- ./breadcrumbs -->    
      ...
      <h1>BA Theatre and Film Studies</h1>
...
<div class="row with-margin">
    <div class="small-12 columns">
        <div class="course-header">
            <img src="/media/sample-site/content-assets/global-content-assets/images/courses/film-studies.jpg" alt="Film Studies" >
            <h2 class=
"h1">BA Theatre and Film Studies</h2>
        </div>
    </div>
</div>
...
<div class="row course-info">
          ...
          <div class="small-12 medium-6 columns">
                                                                                                               <p><strong>Course Code:</strong> <span class="code">BA/TFS</span></p>
          </div>
      ...
      <div class="small-12 medium-6 columns">
          ...
          <div class="small-12 medium-6 columns">
                <p><strong>Department:</strong> <span class="dept">Film</span></p>
          </div>
      
          
          <div class="small-12 medium-6 columns">
                <p><strong>Faculty:</strong> <span class="faculty">Faculty of Arts</span></p>
          </div>
      

    
          <div class="small-12 medium-6 columns">
                 <p><strong>Accreditation:</strong> <span class="accreditation">Bachelor of Arts</span></p>
          </div>
          ...
          <div class="small-12 medium-6 columns">
                <p><strong>Course Contact:</strong> <span class="contact">Tracy Brobyn</span></p>
          </div>
     
  	 <div class="small-12 medium-6 columns">
                <p><strong>Credit Requirement:</strong> <span class="credit_rqt">360</span></p>
          </div> 
<div class="small-12 medium-6 columns">
 ...
 <!-- ./side bar course info -->
     ...
     <div class="course-page">
	      ...
	      <div class='add course_compare_btn view_saved_c_btn showAdd'>
	          <a href='/course-hub/course-compare/?addCourse=960' class='save button course-960'><span class='fa fa-plus'></span>&nbsp; Save this course</a>
	      </div>

	      <div class='remove view_saved_c_btn course_compare_btn hideRemove'>
	          <a href='/course-hub/course-compare/?removeCourse=960' class='save button course-960'><span class='fa fa-check'></span>&nbsp; Saved</a>
        ...
        <div class="overview">
            <p>The academic scope of this programme enables students to understand the histories of theatre and cinema and their industries and explores the critical debates concerning the cultural and political influences of theatre and film. The programme also explores the spaces of the stage and studio, stage and screen performances and the genres, narratives and authorship of plays and screenplays. We also study the economics and management of theatre and cinema within the creative industries.
<br />
<br />The study of these two artistically and economically important cultural forms side by side enables students of this programme to appreciate the connections and distinctions between them and to meet the challenges of employment in a society in which the creative industries play an important role.
<br />
<br />In Year One, courses provide a broad understanding of how theatre and film work as creative industries, introduce the study of theatre and film narrative and performance, and provide experience of creative production. Year Two examines questions of genre and creativity alongside the theory and practice of stage performance. Year Three looks at key periods, movements and practitioners in theatre and film drama, alongside courses in areas such as adaptation, comedy, playwriting, and Hollywood cinema.
<br />
<br />Learning and teaching methods vary: lectures, seminars, individual work and group work, where you will be producing a range of performance events and production material. 
<br />
<br />Career opportunities
<br />You may use your studies as a basis for professional practice within theatre, film and allied industries, using the specialisms as a stepping stone to a variety of careers in: theatre industry; film industries; professions requiring skills in communication and creativity; drama teaching; and postgraduate study.</p>
        </div>
  ...
  <a class="button applicationLink" href="http://ukcloud38-inbssbmachine.cloud.elluciandemo.com:9010/CLOUD38/bwkkspgr.showpage?page=ESC_PROGCAT_PRGREQ&pname=PPROGCODE&pvalue=BA/TFS&pname=TERM&pvalue=201601">Additional Course Information</a>
