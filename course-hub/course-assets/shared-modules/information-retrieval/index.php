...
<!--[if (gt IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <head>
    ...
    <title>Information Retrieval - TERMINALFOUR University</title>
      <!-- Inner page left nav -->
...
<div class="row"><div class="small-12 columns">
  <nav class="breadcrumbs">
	<ul><li><a href="/">Home</a></li><li><a href="/course-hub/">Course Hub</a></li><li><a href="/course-hub/course-assets/">Course Assets</a></li><li><a href="/course-hub/course-assets/shared-modules/">Shared Modules</a></li><li><a href="/course-hub/course-assets/shared-modules/information-retrieval/">Information Retrieval</a></li></ul>
  </nav>
</div>
</div>
  <!-- ./breadcrumbs -->    
...
<p>This module considers the organisation, storage and retrieval of unstructured information based on its content. World Wide Web search engines will be used extensively both as a source of material and for demonstration purposes. Additionally, current issues in the information industry are addressed.</p><!-- start of SM footer -->
  </div>
