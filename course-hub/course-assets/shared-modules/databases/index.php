...
<!--[if (gt IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <head>
    ...
    <title>Databases - TERMINALFOUR University</title>
      <!-- Inner page left nav -->
...
<div class="row"><div class="small-12 columns">
  <nav class="breadcrumbs">
	<ul><li><a href="/">Home</a></li><li><a href="/course-hub/">Course Hub</a></li><li><a href="/course-hub/course-assets/">Course Assets</a></li><li><a href="/course-hub/course-assets/shared-modules/">Shared Modules</a></li><li><a href="/course-hub/course-assets/shared-modules/databases/">Databases</a></li></ul>
  </nav>
</div>
</div>
  <!-- ./breadcrumbs -->    
...
<p>To introduce students to the concepts and issues concerning multiuser, networked relational databases in a practical environment. To provide a solid foundation in SQL.</p><!-- start of SM footer -->
  </div>
