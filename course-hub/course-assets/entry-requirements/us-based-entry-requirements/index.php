...
<!--[if (gt IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <head>
    ...
    <title>US Based Entry Requirements - TERMINALFOUR University</title>
      <!-- Inner page left nav -->
...
<div class="row"><div class="small-12 columns">
  <nav class="breadcrumbs">
	<ul><li><a href="/">Home</a></li><li><a href="/course-hub/">Course Hub</a></li><li><a href="/course-hub/course-assets/">Course Assets</a></li><li><a href="/course-hub/course-assets/entry-requirements/">Entry Requirements</a></li><li><a href="/course-hub/course-assets/entry-requirements/us-based-entry-requirements/">US Based Entry Requirements</a></li></ul>
  </nav>
</div>
</div>
  <!-- ./breadcrumbs -->    
      ...
      <h1>US Based Entry Requirements</h1>
...
<p><strong>Course requirements:</strong>&nbsp;Graduate credit is awarded for courses numbered 5000 and above. The program of course work for a master’s degree must be approved by the student’s adviser, supervisory committee, or faculty representative of the academic unit. No more than 9 credits from a previous master’s degree program may apply toward a second master’s degree. These credits are applied only with the written approval of the Dean of the Graduate School.</p><p>US based entry requirements -<strong> Students should have completed a four-year U.S. bachelor’s degree or the U.S. equivalent</strong>. Average GRE scores of admitted graduate students (all programs) are: 159 (verbal), 163 (quantitative), 4.1 (analytical). In addition to this, international students should have obtained a minimum TOEFL score of 88 on iBT/230 on CBT/570 on PBT. In lieu of the TOEFL student might have obtained a minimum IELTS score of 6.5, or PTE (Pearson’s Test of English) score of 60.</p>
<p>&nbsp;</p><!-- start of SM footer -->
  </div>
