...
<!--[if (gt IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <head>
    ...
    <title>Postgraduate - TERMINALFOUR University</title>
      <!-- Inner page left nav -->
...
<div class="row"><div class="small-12 columns">
  <nav class="breadcrumbs">
	<ul><li><a href="/">Home</a></li><li><a href="/course-hub/">Course Hub</a></li><li><a href="/course-hub/course-assets/">Course Assets</a></li><li><a href="/course-hub/course-assets/generic-learning-outcomes/">Generic Learning Outcomes</a></li><li><a href="/course-hub/course-assets/generic-learning-outcomes/postgraduate/">Postgraduate</a></li></ul>
  </nav>
</div>
</div>
  <!-- ./breadcrumbs -->    
      ...
      <h1>Postgraduate</h1>
           ...
           <!-- end of SM header -->
<p>Post grad learning outcome information - matched off course code</p><!-- start of SM footer -->
  </div>
