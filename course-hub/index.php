...
<!--[if (gt IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <head>
    ...
    <title>Course Hub - TERMINALFOUR University</title>
      <!-- Inner page left nav -->
...
<!-- End Google Tag Manager -->
    ...
    <meta name="description" content="TERMINALFOUR University is the number one choice for students. Studying with us gives you the chance to expand your career options and learn from internationally-renowned teachers and researchers." /><!-- description -->
    <!-- keywords -->
    ...
    <meta property="og:description" content="TERMINALFOUR University is the number one choice for students. Studying with us gives you the chance to expand your career options and learn from internationally-renowned teachers and researchers." /><!-- og:description -->
    <!-- og:image -->
...
<div class="parallax parallax-large">
  <img data-interchange="[[/media/sample-site/content-assets/global-content-assets/images/parallax-images/book-med.jpg,(medium)],[/media/sample-site/content-assets/global-content-assets/images/parallax-images/book-lrg.jpg,(large)]," alt="An open book" src="/media/sample-site/content-assets/global-content-assets/images/parallax-images/book-lrg.jpg" />
  <noscript>
    <img src="/media/sample-site/content-assets/global-content-assets/images/parallax-images/book-lrg.jpg" alt="An open book" />
  </noscript>
...
<div class="row"><div class="small-12 columns">
  <nav class="breadcrumbs">
	<ul><li><a href="/">Home</a></li><li><a href="/course-hub/">Course Hub</a></li></ul>
  </nav>
</div>
</div>
  <!-- ./breadcrumbs -->    
...
<div class="general">
  ...
  <p class="intro">TERMINALFOUR University is the number one choice for students. Studying with us gives you the chance to expand your career options and learn from internationally-renowned teachers and researchers.</p>
  <div class="content"><h2>We offer a wide range of courses</h2>
<p>With both undergraduate and postgraduate qualifications. Our courses offer you flexibility to follow your own interests rather than always follow a prescribed course of study. This is a word document</p>
<h3>No matter what and where you want to study, there is a course that is right for you.</h3>
<p>Within our course hub you can:</p>
<ul>
<li>Find a course quickly with our <a href="/course-hub/basic-course-search/">basic course search</a>.</li>
<li>Spend a little more time filtering through courses to suit your exact needs using our <a href="/course-hub/advanced-course-search/">advanced search</a>.</li>
<li>Use the course catalog builder to <a href="/course-hub/course-catalog-builder/">create a course catalog</a>&nbsp;tailored perfectly for you.</li>
<li><a href="/course-hub/course-compare/">Compare courses</a>&nbsp;that you've saved during your searches to help you make up your mind.</li>
</ul>
<p>Found a course and now want to know about the people you'll be working with? Have a look at our <a href="/research/staff-directory/">Staff Directory</a>&nbsp;to find out more about our outstanding staff here at <strong>TERMINALFOUR</strong> University.</p></div>
