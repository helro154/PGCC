...
<!--[if (gt IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <head>
    ...
    <title>Shannon Talley - TERMINALFOUR University</title>
      <!-- Inner page left nav -->
...
<div class="row"><div class="small-12 columns">
  <nav class="breadcrumbs">
	<ul><li><a href="/">Home</a></li><li><a href="/course-hub/">Course Hub</a></li><li><a href="/course-hub/tutors/">Tutors</a></li><li><a href="/course-hub/tutors/shannon-talley/">Shannon Talley</a></li></ul>
  </nav>
</div>
</div>
  <!-- ./breadcrumbs -->    
      ...
      <h1>Shannon Talley</h1>

           <!-- end of SM header -->
<div class="small-12 medium-6 columns">
  <p><strong>First name:</strong> Shannon</p>
  <p><strong>Last name:</strong> Talley</p>
  <p>Dr. Sc. with a specialization in building systems</p>
<p>M.S. in Environmental Engineering</p>
