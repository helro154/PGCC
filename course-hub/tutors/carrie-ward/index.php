...
<!--[if (gt IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <head>
    ...
    <title>Carrie Ward - TERMINALFOUR University</title>
      <!-- Inner page left nav -->
...
<div class="row"><div class="small-12 columns">
  <nav class="breadcrumbs">
	<ul><li><a href="/">Home</a></li><li><a href="/course-hub/">Course Hub</a></li><li><a href="/course-hub/tutors/">Tutors</a></li><li><a href="/course-hub/tutors/carrie-ward/">Carrie Ward</a></li></ul>
  </nav>
</div>
</div>
  <!-- ./breadcrumbs -->    
...
<div class="small-12 medium-6 columns">
  <p><strong>First name:</strong> Carrie</p>
  <p><strong>Last name:</strong> Ward</p>
  <ul>
<li>Master's in Mathematics&nbsp;</li>
<li>Bachelor's in Architecture from Cambridge University</li>
<li>PhD in Architecture from T4U</li>
</ul>
