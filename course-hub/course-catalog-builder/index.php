...
try {
  ...
  require(realpath($_SERVER["DOCUMENT_ROOT"]) . '/course-hub/course-catalog-builder/configuration/prospectus-builder-container/' . 'index.php');

  $json_data = new FormatJSON();
  ...
  if(!$_POST || !isset($_POST['selections']) || empty($_POST['selections'])) {
...
<!--[if (gt IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <head>
    ...
    <title>Course Catalog Builder - TERMINALFOUR University</title>
      <!-- Inner page left nav -->
...
<!-- End Google Tag Manager -->
    ...
    <meta name="description" content="Choose the courses that matter to you" /><!-- description -->
    <!-- keywords -->
    ...
    <!-- og:title -->
    <meta property="og:description" content="Choose the courses that matter to you" /><!-- og:description -->
    <!-- og:image -->
    <!-- og:type -->
...
<div class="row"><div class="small-12 columns">
  <nav class="breadcrumbs">
	<ul><li><a href="/">Home</a></li><li><a href="/course-hub/">Course Hub</a></li><li><a href="/course-hub/course-catalog-builder/">Course Catalog Builder</a></li></ul>
  </nav>
</div>
</div>
  <!-- ./breadcrumbs -->    
...
if($_POST) {
	echo "<div class=\"alert-box alert\">Please select some courses</div>";
}
...
<div class="general">
  ...
  <p class="intro">Choose the courses that matter to you</p>
  <div class="content"><p>You can tailor-make your own course catalog&nbsp;containing just the courses that you're interested in. Select the parts of a course you want included and then click <em>Create course catalog</em>.</p></div>
</div><?php $html = new GetHTML($json_data); ?>
<?php
...
<!-- start of SM footer -->
  ...
  <div class="small-12 medium-3 medium-pull-9 columns">
    <nav>
      <header>
    <div class="h4 side-nav-header"><a href="/course-hub/">Course Hub</a>
      </div>
      </header>
    <ul class="side-nav">
      <li><a href="/course-hub/undergraduate-courses/">Undergraduate Courses</a></li><li><a href="/course-hub/postgraduate-courses/">Postgraduate Courses</a></li><li><a href="/course-hub/basic-course-search/">Basic Course Search</a></li><li><a href="/course-hub/advanced-course-search/">Advanced Course Search</a></li><li><a href="/course-hub/course-compare/">Course Compare</a></li><li><span class="currentbranch0"><a href="/course-hub/course-catalog-builder/">Course Catalog Builder</a></span></li>
    </ul>
    </nav>
    <?php
 try {
...
<script src="/media/sample-site/site-assets/javascript/course-compare/course-compare.js"></script> <!-- prospectus builder custom .js -->

<script src="/media/sample-site/site-assets/javascript/course-catalog-builder/course-catalog-builder.js"></script> <!-- course catalog builder .js -->
