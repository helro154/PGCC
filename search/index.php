...
<!--[if (gt IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <head>
    ...
    <title>Search - TERMINALFOUR University</title>
      <!-- Inner page left nav -->
...
<!-- End Google Tag Manager -->
    ...
    <!-- og:description -->
    <!-- og:image -->
    <meta property="og:type" content="article" /><meta property="og:url" content="https://samplesite.terminalfour.com/search/" /><meta property="og:title" content="Search" />
...
<div class="row"><div class="small-12 columns">
  <nav class="breadcrumbs">
	<ul><li><a href="/">Home</a></li><li><a href="/search/">Search</a></li></ul>
  </nav>
</div>
</div>
  <!-- ./breadcrumbs -->    
...
<script>
  (function() {
    var cx = '004875206218447963154:cjrxahypsi0';
...
<!-- start of SM footer -->
  ...
  <div class="small-12 medium-3 medium-pull-9 columns">
    <nav>
      <header>
    <div class="h4 side-nav-header"><a href="/search/">Search</a></div>
      </header>
    <ul class="side-nav">
