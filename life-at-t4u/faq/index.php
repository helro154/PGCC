...
<!-- conditional statements -->
  ...
  <head>
    ...
    <title>FAQ - TERMINALFOUR University</title>
      <!-- Inner page wide -->
...
<div class="row"><div class="small-12 columns">
  <nav class="breadcrumbs">
	<ul><li><a href="/">Home</a></li><li><a href="/life-at-t4u/">Life at T4U</a></li><li><a href="/life-at-t4u/faq/">FAQ</a></li></ul>
  </nav>
</div>
</div>
  <!-- ./breadcrumbs -->    
...
<!-- End of Header --><h2 class="h3">Frequently Asked Questions</h2>

<dl class="accordion" data-accordion>
  <dt class="hidden">Choose question</dt>
    <dd class="accordion-navigation">
    <a href="#item-396">Are there campus tours for visitors?</a>
    <div id="item-396" class="content">
      <p>Visitors are welcomed from all over the world to TERMINALFOUR University. Campus tours are available, as well as graduate and undergraduate admissions tours.</p>
    </div>
  </dd>  <dd class="accordion-navigation">
    <a href="#item-394">Do you accept international students?</a>
    <div id="item-394" class="content">
      <p>Yes. Students living abroad may be eligible to attend our online campus. For more information please contact a University representative at +1 555 123 456.</p>
    </div>
  </dd>  <dd class="accordion-navigation">
    <a href="#item-395">How can I order a course catalog?</a>
    <div id="item-395" class="content">
      <p>Contact <a href="mailto:info@t4u.edu">info@t4u.edu</a>&nbsp;for information on a printed prospectus. Alternatively, use our online prospectus builder to build a <a href="/course-hub/course-catalog-builder/">course catalog</a>&nbsp;for your needs.</p>
    </div>
  </dd>  <dd class="accordion-navigation">
    <a href="#item-398">How can I pay the application fee?</a>
    <div id="item-398" class="content">
      <p>You can pay by credit card when you submit your application, or you can send a check or money order, payable in U.S. funds.</p>
    </div>
  </dd>  <dd class="accordion-navigation">
    <a href="#item-397">How can I meet current students during my visit to the TERMINALFOUR University campus?</a>
    <div id="item-397" class="content">
      <p>Current students and recent alumni are on staff at the Visitor Center and welcome your questions. In addition, TERMINALFOUR University students typically enjoy talking about their experiences, and you are welcome to ask questions of any student that you see walking around campus.</p>
    </div>
  </dd>
</dl><!-- Start of footer -->
  </div>
