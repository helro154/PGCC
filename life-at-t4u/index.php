...
<!--[if (gt IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <head>
    ...
    <title>Life at T4U - TERMINALFOUR University</title>
      <!-- Inner page left nav -->
...
<!-- End Google Tag Manager -->
    ...
    <meta name="description" content="TERMINALFOUR is more than just a university; it&rsquo;s a way of life. " /><!-- description -->
    <!-- keywords -->
    ...
    <meta property="og:description" content="TERMINALFOUR is more than just a university; it&rsquo;s a way of life. " /><!-- og:description -->
    <!-- og:image -->
    <meta property="og:type" content="article" /><meta property="og:url" content="https://samplesite.terminalfour.com/life-at-t4u/" /><meta property="og:title" content="Life at T4U" />
...
<div class="parallax parallax-large">
  <img data-interchange="[[/media/sample-site/content-assets/global-content-assets/images/parallax-images/blogging-med.jpg,(medium)],[/media/sample-site/content-assets/global-content-assets/images/parallax-images/blogging-lrg.jpg,(large)]," alt="Person typing on a laptop" src="/media/sample-site/content-assets/global-content-assets/images/parallax-images/blogging-lrg.jpg" />
  <noscript>
    <img src="/media/sample-site/content-assets/global-content-assets/images/parallax-images/blogging-lrg.jpg" alt="Person typing on a laptop" />
  </noscript>
</div> <!-- current section parallax -->    
...
<div class="row"><div class="small-12 columns">
  <nav class="breadcrumbs">
	<ul><li><a href="/">Home</a></li><li><a href="/life-at-t4u/">Life at T4U</a></li></ul>
  </nav>
</div>
</div>
  <!-- ./breadcrumbs -->    
...
<div class="general">
  ...
  <p class="intro">TERMINALFOUR is more than just a university; it’s a way of life. </p>
  <div class="content"><p>TERMINALFOUR University’s campus is always bustling with students, conversation and new ideas. The campus is home to state of the art media libraries, modern facilities and extensive grounds to explore.&nbsp;</p></div>
</div><div class="row">
  ...
  <div class="small-12 large-6 columns">
    <div class="flex-video">
      <iframe src="//www.youtube.com/embed/YPDM33PfUQY?enablejsapi=1&rel=0
" width="500" height="281"  allowfullscreen></iframe>
    </div>
  </div>
  <div class="small-12 large-6 columns">
    <div class="flex-video">
      <iframe src="//www.youtube.com/embed/iDXTwAg6cxY?enablejsapi=1&rel=0
" width="500" height="281"   allowfullscreen></iframe>
    </div>
  </div>
</div><!-- /.row -->
...
<div class="row">
  <div class="small-12 large-6 columns">
    <p>We understand that student success is more than just grades alone which is why we provide a range of programs, services, facilities and operations that are designed to enrich the TERMINALFOUR student experience.</p>
<p>Our goal is to support the success of the student both here at the university and beyond. &nbsp;You will find information in this section about valuable services and programs that will help you to navigate the university, stay physically and mentally healthy, meet new friends and network, develop a career path, explore housing options, register for classes, manage finances and scholarships, and much more.&nbsp;</p>
  </div>
  <div class="small-12 large-6 columns">
  	<p>All of us at the University of TERMINALFOUR are committed to providing students with every opportunity to ensure they get the most out of their time here.</p>
<p>Whether you are a student, parent, alumni member, or partner of the university, we extend our welcome and we look forward to seeing you on campus.</p>
...
<!-- start of SM footer -->
  ...
  <div class="small-12 medium-3 medium-pull-9 columns">
    <nav>
      <header>
    <div class="h4 side-nav-header"><a href="/life-at-t4u/">Life at T4U</a></div>
      </header>
    <ul class="side-nav">
      <li><a href="/life-at-t4u/campuses/">Campuses</a></li><li><a href="/life-at-t4u/faq/">FAQ</a></li><li><a href="/life-at-t4u/student-support/">Student Support</a></li><li><a href="/life-at-t4u/blog/">Blog</a></li>
    </ul>
    </nav>
