			...
			this.defaults = {
				feeds: {
					facebook: {
						...
						url: '/media/sample-site/site-assets/php/social-stream/facebook.php',
						feed: 'feed', // feed, posts
						icon: '/media/sample-site/site-assets/images/social-stream/facebook.png'
					},
					twitter: {
						id: '',
						intro: 'Tweeted',
						...
						url: '/media/sample-site/site-assets/php/social-stream/twitter.php',
						icon: '/media/sample-site/site-assets/images/social-stream/twitter.png'
					},
					google: {
						id: '',
						intro: 'Shared',
						...
						image_width: 300,
						shares: true,
						icon: '/media/sample-site/site-assets/images/social-stream/google.png'
					},
					youtube: {
						id: '',
						intro: 'Uploaded',
						...
						icon: '/media/sample-site/site-assets/images/social-stream/youtube.png'
					},
					flickr: {
						id: '',
						intro: 'Uploaded',
						out: 'intro,thumb,title,text,share',
						lang: 'en-us',
						icon: '/media/sample-site/site-assets/images/social-stream/flickr.png'
					},
					delicious: {
						id: '',
						intro: 'Bookmarked',
						out: 'intro,thumb,title,text,user,share',
						icon: '/media/sample-site/site-assets/images/social-stream/delicious.png'
					},
					rss: {
						id: '',
						intro: 'Posted',
						out: 'intro,thumb,title,text,user,share',
						url: '/media/sample-site/site-assets/php/social-stream/rss.php',
						text: 'contentSnippet',
						icon: '/media/sample-site/site-assets/images/social-stream/rss.png'
					},
					lastfm: {
						id: '',
					...
					dribbble: {
						...
						feed: 'shots,likes',
						icon: '/media/sample-site/site-assets/images/social-stream/dribbble.png'
					},
					vimeo: {
						id: '',
						...
						thumb: 'large',
						stats: true,
						icon: '/media/sample-site/site-assets/images/social-stream/vimeo.png'
					},
					stumbleupon: {
						id: '',
						...
						icon: '/media/sample-site/site-assets/images/social-stream/stumbleupon.png'
					},
					deviantart: {
						id: '',
						intro: 'Deviation',
						out: 'intro,thumb,title,text,user,share',
						icon: '/media/sample-site/site-assets/images/social-stream/deviantart.png'
					},
					tumblr: {
						id: '',
						intro: 'Posted',
						...
						thumb: 100,
						video: 250,
						icon: '/media/sample-site/site-assets/images/social-stream/tumblr.png'
					},
					instagram: {
						id: '',
					    intro: 'Posted',
						...
						icon: '/media/sample-site/site-assets/images/social-stream/instagram.png'
					}
				},
				remove: '',
				twitterId: '',
