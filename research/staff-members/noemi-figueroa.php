...
<!--[if (gt IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <head>
    ...
    <title>Staff Members: Post Doctoral Researcher - TERMINALFOUR University</title>
      <!-- Inner page left nav -->
...
<!-- End Google Tag Manager -->
    ...
    <meta property="og:description" content="<p>Noemi&nbsp;came to the Simons Foundation in 2010. Having changed professional paths after an early career as a visual artist, Noemi has worked in a variety of fields, including lecturing classics at Stanford University. Noemi graduated with a bachelor&rsquo;s degree in computer science from Dartmouth College.</p>" /><!-- og:description -->
    ...
    <meta name="profile:first_name" content="Noemi" /><!-- profile:first_name -->
    <meta name="profile:last_name" content="Figueroa" /><!-- profile:last_name -->
...
<div class="row"><div class="small-12 columns">
  <nav class="breadcrumbs">
	<ul><li><a href="/">Home</a></li><li><a href="/research/">Research</a></li><li><a href="/research/staff-members/">Staff Members</a></li><li>Post Doctoral Researcher</li></ul>
  </nav>
</div>
</div>
  <!-- ./breadcrumbs -->    
...
<div class="row">
    ...
    -->
        ...
        <h2>Noemi Figueroa<br><small>Researcher</small></h2>
        <table style="width: 100%;">
            <tr><td>Email</td><td><a href="mailto:noemifigueroa&#64;t4u&#46;com">noemifigueroa&#64;t4u&#46;com</a></td></tr>
            <tr><td>Department</td><td>Computer Science</td></tr>
            <tr><td>Phone</td><td><a href='tel:+1 (932) 424-2000'>+1 (932) 424-2000</a></td></tr>
        </table>

        <!--<span class="label success">Available</span>
        <span class="label alert">Not Available</span>-->
        <div class='panel callout'><h3>Contactable Hours</h3><ul>
<li>Thursday 14:00 - 17:30</li>
</ul></div>
    </div>
    ...
    <div class="small-12 columns">
        ...
        <div class="tabs-content">
            <div class="content active" id="panel1">
                <p>Noemi&nbsp;came to the Simons Foundation in 2010. Having changed professional paths after an early career as a visual artist, Noemi has worked in a variety of fields, including lecturing classics at Stanford University. Noemi graduated with a bachelor’s degree in computer science from Dartmouth College.</p>
            </div>
