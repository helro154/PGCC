...
<!--[if (gt IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <head>
    ...
    <title>Staff Members: Senior Lecturer - TERMINALFOUR University</title>
      <!-- Inner page left nav -->
...
<!-- End Google Tag Manager -->
    ...
    <meta name="profile:first_name" content="May" /><!-- profile:first_name -->
    <meta name="profile:last_name" content="Olson" /><!-- profile:last_name -->
...
<div class="row"><div class="small-12 columns">
  <nav class="breadcrumbs">
	<ul><li><a href="/">Home</a></li><li><a href="/research/">Research</a></li><li><a href="/research/staff-members/">Staff Members</a></li><li>Senior Lecturer</li></ul>
  </nav>
</div>
</div>
  <!-- ./breadcrumbs -->    
      ...
      <h1>Staff Members</h1>
           ...
           <!-- end of SM header -->
<div class="row">
    <div class="small-12 large-6 columns text-center"><img src="/media/sample-site/content-assets/global-content-assets/images/staff-members/person2.png" alt="Generic staff profile image" ></div>
    <!--
    -->
    ...
    -->
        ...
        <h2>May Olson<br><small>Researcher</small></h2>
        <table style="width: 100%;">
            <tr><td>Email</td><td><a href="mailto:mayolson&#64;t4u&#46;com">mayolson&#64;t4u&#46;com</a></td></tr>
            <tr><td>Department</td><td>Medicine</td></tr>
            <tr><td>Phone</td><td><a href='tel:+1 (926) 469-3631'>+1 (926) 469-3631</a></td></tr>
        </table>
    ...
    <div class="small-12 columns">
        ...
        <dl class="tabs" data-tab>
            ...
            <dd><a href='#panel2'>Publications</a></dd>
            
        </dl>
        <div class="tabs-content">
            <div class="content active" id="panel1">
                <p>May Olson&nbsp;joined the university in 2013, bringing with her experience in both the corporate and academic research worlds. Previously, Olson worked at Rockefeller University in New York as research assistant to Paul Greengard, head of the Laboratory of Molecular and Cellular Neuroscience.</p>
            </div>
            <div class='content' id='panel2'><ul>
<li>Jean Healy, Rena Lyons, Mary Pat O Malley and May Olson&nbsp;(2010) 'Preparing health care workers for a bilingual and multicultural context: learning from an undergraduate speech and language therapy programme'. Translocation: Migration And Social Change, 6 (1).</li>
<li>Olson, M. (2000) 'The effect of category-size and experimental context on semantic congruity in semantic verification task'. Psihologija, 1-2 :13-35.</li>
<li>Olson, M., Kostiæ, A. (1996) 'Visual field effects on the processing of inflected noun forms'. Linguistic Abstracts, 12.</li>
</ul></div>
