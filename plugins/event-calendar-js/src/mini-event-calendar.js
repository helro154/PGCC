(function( $ ) {
	var calenderTpl = '<div id="calTitle"><button class="month-mover prev"><svg fill="#002c77" height="30" viewBox="0 0 24 24" width="30" xmlns="http://www.w3.org/2000/svg"><path d="M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z"/><path d="M0 0h24v24H0z" fill="none"/></svg></button><div id="monthYear"></div><button class="month-mover next"><svg fill="#002c77" height="30" viewBox="0 0 24 24" width="30" xmlns="http://www.w3.org/2000/svg"><path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"/><path d="M0 0h24v24H0z" fill="none"/></svg></button></div><div><div id="calThead"><div>S</div><div>M</div><div>T</div><div>W</div><div>T</div><div>F</div><div>S</div></div><div id="calTbody"></div></div><div id="calTFooter"><h3 id="eventTitle">No events today.</h3><a href="javascript:void(0);" id="callDay">Day</a>|<a href="javascript:void(0);" id="callWeek">Week</a>|<a href="javascript:void(0);" id="callMonth">Month</a>|<a href="javascript:void(0);" id="callYear">Year</a>|<a href="javascript:void(0);" id="calLink">ALL</a></div>';
    ...
    $.fn.miniEventCalendar = $.fn.MEC = function(options) {
		...
		var events_month = mini_cal.find("#callMonth");
		...
		events_month.attr("href", settings.calendar_month);
