...
<!--[if (gt IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <head>
    ...
    <title>Alumni - TERMINALFOUR University</title>
...
<!-- End Google Tag Manager -->
    ...
    <!--canonical-->
    <meta name="description" content="The TERMINALFOUR University experience means much more than just your short years on campus." /><!-- description -->
    <!-- keywords -->
     <!-- course code -->
    <!-- course type -->
    <!-- location -->
    ...
    <meta property="og:description" content="The TERMINALFOUR University experience means much more than just your short years on campus." /><!-- og:description -->
    <!-- og:image -->
    <!-- og:type -->
...
<div class="parallax parallax-small">
  <img data-interchange="[[/media/sample-site/content-assets/global-content-assets/images/parallax-images/typewriter-med.jpg,(medium)],[/media/sample-site/content-assets/global-content-assets/images/parallax-images/typewriter-lrg.jpg,(large)]," alt="Close up on the keys of a typewriter" src="/media/sample-site/content-assets/global-content-assets/images/parallax-images/typewriter-lrg.jpg" />
  <noscript>
    <img src="/media/sample-site/content-assets/global-content-assets/images/parallax-images/typewriter-lrg.jpg" alt="Close up on the keys of a typewriter" />
  </noscript>
</div>
...
<div class="row">
	<div class="small-12 columns">
		    <nav class="breadcrumbs">
	            <ul><li><a href="/">Home</a></li><li><a href="/alumni/">Alumni</a></li></ul>
            </nav>
	</div>
</div>
<!-- ./breadcrumbs -->
...
<div class="general">
  ...
  <p class="intro">The TERMINALFOUR University experience means much more than just your short years on campus.</p>
  <div class="content"><p>Alumni find TERMINALFOUR just as exciting, inspiring and enriching after graduation and it’s a connection that lasts a lifetime. Once graduated, all undergraduate and graduate students automatically become members of the Alumni Association of Princeton University.</p>
<h2>Benefits</h2>
<p>There are many benefits to this, not least of which is the unlimited use of their online suite of services, including a searchable online alumni directory, the alumni careers network and hundreds of discussion groups.</p>
<p>We encourage all TERMINALFOUR alumni to browse our website to learn about the many services and programs offered by the Alumni association.&nbsp;</p></div>
</div><div class="row">
  <div class="small-12 columns">
    <h3 class="subheader">Image gallery</h3>
    <ul class="clearing-thumbs small-block-grid-2 medium-block-grid-4 large-block-grid-6" data-clearing>
		<li><a href="/media/sample-site/content-assets/global-content-assets/images/gallery/109H-600.jpg" class="th"><img data-caption="Skateboarder on campus" src="/media/sample-site/content-assets/global-content-assets/images/gallery/109H-150.jpg" alt="Item 1 - skateboard" /></a></li><li><a href="/media/sample-site/content-assets/global-content-assets/images/gallery/2177958504_4e14d0f1ee_o-600.jpg" class="th"><img data-caption="Library Building" src="/media/sample-site/content-assets/global-content-assets/images/gallery/2177958504_4e14d0f1ee_o-150.jpg" alt="Item 2 - college hall" /></a></li><li><a href="/media/sample-site/content-assets/global-content-assets/images/gallery/33H-600.jpg" class="th"><img data-caption="Exam Hall Chairs" src="/media/sample-site/content-assets/global-content-assets/images/gallery/33H-150.jpg" alt="Item 3 - chairs" /></a></li><li><a href="/media/sample-site/content-assets/global-content-assets/images/gallery/43H-600.jpg" class="th"><img data-caption="Students legs in the canteen" src="/media/sample-site/content-assets/global-content-assets/images/gallery/43H-150.jpg" alt="Item 4 - people" /></a></li><li><a href="/media/sample-site/content-assets/global-content-assets/images/gallery/59H-600.jpg" class="th"><img data-caption="Science Building" src="/media/sample-site/content-assets/global-content-assets/images/gallery/59H-150.jpg" alt="Item 5 - building" /></a></li>
	</ul>
