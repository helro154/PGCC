...
<!-- End Google Tag Manager -->
    ...
    <!--canonical-->
    <meta name="description" content="Thanks for submitting your event. We will be back to you as soon as possible." /><!-- description -->
    <!-- keywords -->
     <!-- course code -->
    <!-- course type -->
    <!-- location -->
    ...
    <meta property="og:description" content="Thanks for submitting your event. We will be back to you as soon as possible." /><!-- og:description -->
    <!-- og:image -->
    <!-- og:type -->
...
<div class="row">
	<div class="small-12 columns">
		    <nav class="breadcrumbs">
	            <ul><li><a href="/">Home</a></li><li><a href="/alumni/">Alumni</a></li><li><a href="/alumni/events/">Events</a></li><li><a href="/alumni/events/thank-you/">Thank you</a></li></ul>
            </nav>
	</div>
</div>
<!-- ./breadcrumbs -->
...
<div class="general">
  ...
  <p class="intro">Thanks for submitting your event. We will be back to you as soon as possible.</p>
