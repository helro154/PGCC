...
<!--[if (gt IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <head>
    ...
    <title>Events: Commencement Ceremony - TERMINALFOUR University</title>
...
<!-- End Google Tag Manager -->
    ...
    <!-- start date -->
    <meta name="enddate" content="Tue, 22 Oct 2019 12:25:00 EDT" /><!-- end date -->
...
<div class="row">
	<div class="small-12 columns">
		    <nav class="breadcrumbs">
	            <ul><li><a href="/">Home</a></li><li><a href="/alumni/">Alumni</a></li><li><a href="/alumni/events/">Events</a></li><li>Commencement Ceremony</li></ul>
            </nav>
	</div>
</div>
<!-- ./breadcrumbs -->
...
/* Version 0.1.126 */
  ...
  /* Start Catch */
    ...
    echo '<!--'.$e->getMessage().'-->';
    ?>
    <time class="sdate" datetime="2019-17-09">September 17, 2019</time><span class="to-date sr-only"> to <time datetime="2019-22-10">October 22, 2019</time></span> - <a href="#location-map">Cambridge, MA 02142</a>
    <?php
}
/* End Catch */
?>
  </p>
  <p class="intro">A record number of graduates this year plus more than 10,000 friends and family members due to attend.</p>

  <p>During this ceremony degrees will be conferred for all bachelor's and master's candidates.&nbsp;</p>
<p><strong>Tickets</strong></p>
<p>Although tickets are not required for Commencement ceremonies, and there is no limit to the number of guests you may bring, there will be limited seating in the smaller venues based on the number of students participating.&nbsp;</p>
<p><strong>How do I get my cap and gown?</strong><br>Students will be emailed information and instructions on how to order regalia from the Commencement Office.</p>
<p><strong>Official photographs</strong></p>
<p>The university’s official photographer, will take photographs of each graduate participating in the commencement ceremony prior to the procession and also as students cross the platform.</p>
<p><strong>Congratulations to all graduates this year, enjoy your speical day.</strong></p>

  <h2 id="h3 location-map">Cambridge, MA 02142</h2>
  <div class="row">
  ...
  <script type="text/javascript">
    function initialize() {
      var myLatlng = new google.maps.LatLng(42.3783903, -71.1129096);
      var mapOptions = {
        center: myLatlng,
        zoom: 15
      };
...
<div class="ical">
    <a class="button btn btn-default calendar-button" href="<?php echo $t4_module['allevents']; ?>download.php?event_id=997<?php echo isset($event_type) && !empty($event_type) ? '&event_type='.$event_type : ''; ?>">Download Event to Outlook</a>
</div>
<!-- start of SM footer -->
  </div>
