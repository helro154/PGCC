...
<!--[if (gt IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <head>
    ...
    <title>Events: Library Opening Ceremony - TERMINALFOUR University</title>
...
<!-- End Google Tag Manager -->
    ...
    <!-- start date -->
    <meta name="enddate" content="Thu, 10 Oct 2019 14:00:00 EDT" /><!-- end date -->
...
<div class="row">
	<div class="small-12 columns">
		    <nav class="breadcrumbs">
	            <ul><li><a href="/">Home</a></li><li><a href="/alumni/">Alumni</a></li><li><a href="/alumni/events/">Events</a></li><li>Library Opening Ceremony</li></ul>
            </nav>
	</div>
</div>
<!-- ./breadcrumbs -->
...
<article>
  <h1>Library Opening Ceremony</h1>
  <p class="meta">
<?php
try {
/* Version 0.1.126 */
  ...
  /* Start Catch */
    ...
    echo '<!--'.$e->getMessage().'-->';
    ?>
    <time class="sdate" datetime="2019-9-10">October 9, 2019</time><span class="to-date sr-only"> to <time datetime="2019-10-10">October 10, 2019</time></span> - <a href="#location-map">Library Opening Ceremony</a>
    <?php
}
/* End Catch */
?>
  </p>
  <p class="intro">TERMINALFOUR University is opening it's brand new, state of the art library.</p>

  <p>This new library has more than 100 public access computers, theatres, an exhibition gallery and music rooms.</p>
<p>It has been built to replace the previous University Library, built in the 1960s.</p>
<p>Most of the funding has come from our incredibly generous alumni as well as fundraising by student groups over the last number of years. It is a hude asset to the future of TERMINALFOUR University, and it's students.</p>
<p>The hope of all at T4U is that this library will continue to enlighten future generations.</p>

  <h2 id="h3 location-map">Library Opening Ceremony</h2>
  <div class="row">
  ...
  <script type="text/javascript">
    function initialize() {
      var myLatlng = new google.maps.LatLng(53.3439922, -6.2528641);
      var mapOptions = {
        center: myLatlng,
        zoom: 15
      };
...
<div class="ical">
    <a class="button btn btn-default calendar-button" href="<?php echo $t4_module['allevents']; ?>download.php?event_id=999<?php echo isset($event_type) && !empty($event_type) ? '&event_type='.$event_type : ''; ?>">Download Event to Outlook</a>
</div>
<!-- start of SM footer -->
  </div>
