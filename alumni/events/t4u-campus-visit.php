...
<!--[if (gt IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <head>
    ...
    <title>Events: T4U Campus Visit - TERMINALFOUR University</title>
...
<!-- End Google Tag Manager -->
    ...
    <!-- start date -->
    <meta name="enddate" content="Mon, 14 Oct 2019 19:00:00 EDT" /><!-- end date -->
...
<div class="row">
	<div class="small-12 columns">
		    <nav class="breadcrumbs">
	            <ul><li><a href="/">Home</a></li><li><a href="/alumni/">Alumni</a></li><li><a href="/alumni/events/">Events</a></li><li>T4U Campus Visit</li></ul>
            </nav>
	</div>
</div>
<!-- ./breadcrumbs -->
...
/* Version 0.1.126 */
  ...
  /* Start Catch */
    ...
    echo '<!--'.$e->getMessage().'-->';
    ?>
    <time class="sdate" datetime="2019-8-10">October 8, 2019</time><span class="to-date sr-only"> to <time datetime="2019-14-10">October 14, 2019</time></span> - <a href="#location-map">TERMINALFOUR University Campus</a>
    <?php
}
/* End Catch */
?>
  </p>
  <p class="intro">TERMINALFOUR University is opening its doors for a day, and you have a golden ticket.</p>

  <p>You don’t have to attend an open day to apply to TERMINALFOUR University but visiting us does give you a chance to get a real feel for the University.</p>
<p>During the day there will be lots of presentations that outline what TERMINALFOUR University has to offer it's students. Here you'll get information on the application procedure, on student life and important advice on the available financial support for our students.</p>
<p>Our helpful staff and students will be on hand throughout the day to answer any questions you may have about studying at TERMINALFOUR University.</p>

  <h2 id="h3 location-map">TERMINALFOUR University Campus</h2>
  <div class="row">
...
<div class="ical">
    <a class="button btn btn-default calendar-button" href="<?php echo $t4_module['allevents']; ?>download.php?event_id=998<?php echo isset($event_type) && !empty($event_type) ? '&event_type='.$event_type : ''; ?>">Download Event to Outlook</a>
</div>
<!-- start of SM footer -->
  </div>
