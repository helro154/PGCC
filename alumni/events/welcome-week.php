...
<!--[if (gt IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <head>
    ...
    <title>Events: Welcome Week - TERMINALFOUR University</title>
...
<!-- End Google Tag Manager -->
    ...
    <!-- start date -->
    <meta name="enddate" content="Thu, 26 Sep 2019 15:16:00 EDT" /><!-- end date -->
...
<div class="row">
	<div class="small-12 columns">
		    <nav class="breadcrumbs">
	            <ul><li><a href="/">Home</a></li><li><a href="/alumni/">Alumni</a></li><li><a href="/alumni/events/">Events</a></li><li>Welcome Week</li></ul>
            </nav>
	</div>
</div>
<!-- ./breadcrumbs -->
...
/* Version 0.1.126 */
  ...
  /* Start Catch */
    ...
    echo '<!--'.$e->getMessage().'-->';
    ?>
    <time class="sdate" datetime="2019-11-09">September 11, 2019</time><span class="to-date sr-only"> to <time datetime="2019-26-09">September 26, 2019</time></span> - <a href="#location-map">Grandview Plaza</a>
    <?php
}
/* End Catch */
?>
  </p>
  <p class="intro">This event will give an overview of the whole week's plans, as well as introductions to all the 'people-to-know' on campus.</p>

  <p>Welcome Week is designed for you – with lots of exciting activities, campus tours, and social events experienced within a community of students who will make you delighted that you chose TERMINALFOUR University. Make sure you get involved.&nbsp;</p>

  <h2 id="h3 location-map">Grandview Plaza</h2>
  <div class="row">
...
<div class="ical">
    <a class="button btn btn-default calendar-button" href="<?php echo $t4_module['allevents']; ?>download.php?event_id=996<?php echo isset($event_type) && !empty($event_type) ? '&event_type='.$event_type : ''; ?>">Download Event to Outlook</a>
</div>
<!-- start of SM footer -->
  </div>
