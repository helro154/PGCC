...
<!--[if (gt IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <head>
    ...
    <title>2015: Home is where the heart is. TERMINALFOUR University welcomes new academic year students. - TERMINALFOUR University</title>
...
<div class="row">
	<div class="small-12 columns">
		    <nav class="breadcrumbs">
	            <ul><li><a href="/">Home</a></li><li><a href="/alumni/">Alumni</a></li><li><a href="/alumni/news/">News</a></li><li><a href="/alumni/news/2015/">2015</a></li><li>Home is where the heart is. TERMINALFOUR University welcomes new academic year students.</li></ul>
            </nav>
	</div>
</div>
<!-- ./breadcrumbs -->
...
<!-- end of SM header -->
 ...
 <article class="news">
  <h1>Home is where the heart is. TERMINALFOUR University welcomes new academic year students.</h1>
  <p class="meta">Published: <time datetime="2015-05-04">May 4, 2015</time></p>
   <p><strong>Tags:</strong> 
   <a href="/alumni/news/tagged/?tagged=<?php echo rawurlencode('undergraduate'); ?>">undergraduate</a><a href="/alumni/news/tagged/?tagged=<?php echo rawurlencode('T4U'); ?>">, T4U</a></p>
   ...
   <div class="full_article"><p><img src="/media/sample-site/content-assets/global-content-assets/images/news-images/chairs-300x300.jpg" alt="Image of chairs" style="width : 300px; height : 300px;   margin : 0 1em 0;  float : left;" />As part of Welcome Week incoming and returning students participated in various events and programs over the past week before classes began. For returning students it's a "welcome back" to campus as we begin the academic year, for others, it’s the first taste of all that T4U has to offer.</p>
<p>This year we have an extended orientation program designed to facilitate the successful transition of students into T4U living.The program provides lots of opportunities for new students, with benefits ranging from early move-in to your campus residence hall to more connections with new students, and in-depth exploration of university resources before classes begin. We also have fun and interactive sessions on topics such as student involvement, budgeting, library orientation and academic planning. Get to know the campus faculty and staff members through the many events running on Welcome week.</p>
<p>Don't forget to bring your student ID to events to be swiped in for attendance!</p></div>
    
 <div class="prev-next">
    <a href="/alumni/news/2015/terminalfour-university-earns-recognition-in-international-rankings.php" >Previous news story</a><a href="/alumni/news/2015/this-is-more-than-just-an-education-why-choose-terminalfour-university.php" >Next news story</a>
 </div>
