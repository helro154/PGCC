...
<!--[if (gt IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <head>
    ...
    <title>2015: This is more than just an education. Why Choose TERMINALFOUR University - TERMINALFOUR University</title>
...
<div class="row">
	<div class="small-12 columns">
		    <nav class="breadcrumbs">
	            <ul><li><a href="/">Home</a></li><li><a href="/alumni/">Alumni</a></li><li><a href="/alumni/news/">News</a></li><li><a href="/alumni/news/2015/">2015</a></li><li>This is more than just an education. Why Choose TERMINALFOUR University</li></ul>
            </nav>
	</div>
</div>
<!-- ./breadcrumbs -->
...
<!-- end of SM header -->
 ...
 <article class="news">
  <h1>This is more than just an education. Why Choose TERMINALFOUR University</h1>
  <p class="meta">Published: <time datetime="2015-02-20">February 20, 2015</time></p>
   ...
   <p class="intro">
   University is about more than an education. Your university experience gives you the knowledge, skills, confidence and experience to help you make your world better.
   </p>
...
<p><strong>Valuable employability skills</strong><br>An increasing number of graduate jobs do not specify a particular subject area. The skills you will learn in your time at TERMINALFOUR University in the areas of information technology, communication skills, teamwork and problem solving will become invaluable in the search for employment after university.</p></div>
 ...
 <div class="prev-next">
    <a href="/alumni/news/2015/home-is-where-the-heart-is-terminalfour-university-welcomes-new-academic-year-students.php" >Previous news story</a>
 </div>
