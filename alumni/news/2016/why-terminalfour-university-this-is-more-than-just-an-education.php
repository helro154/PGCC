...
<!--[if (gt IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <head>
    ...
    <title>2016: Why TERMINALFOUR University? This is more than just an education. - TERMINALFOUR University</title>
...
<div class="row">
	<div class="small-12 columns">
		    <nav class="breadcrumbs">
	            <ul><li><a href="/">Home</a></li><li><a href="/alumni/">Alumni</a></li><li><a href="/alumni/news/">News</a></li><li><a href="/alumni/news/2016/">2016</a></li><li>Why TERMINALFOUR University? This is more than just an education.</li></ul>
            </nav>
	</div>
</div>
<!-- ./breadcrumbs -->
...
<!-- end of SM header -->
 ...
 <article class="news">
  <h1>Why TERMINALFOUR University? This is more than just an education.</h1>
  <p class="meta">Published: <time datetime="2016-09-22">September 22, 2016</time></p>
   <p><strong>Tags:</strong> 
   <a href="/alumni/news/tagged/?tagged=<?php echo rawurlencode('T4U'); ?>">T4U</a><a href="/alumni/news/tagged/?tagged=<?php echo rawurlencode('Career Prospects'); ?>">, Career Prospects</a></p>
   
   <p class="intro">
   University is about more than an education. Your university experience gives you the knowledge, skills, confidence and experience to help you make your world even better.
   </p>
   
   <div class="full_article"><p><img src="/media/sample-site/content-assets/global-content-assets/images/news-images/bikes-300x300.jpg" alt="A row of bicycles" style="width : 300px; height : 300px;   margin : 0 1em 0;  float : left;" /><strong>Career Prospects</strong><br>One of the best characteristics of the TERMINALFOUR University is that there are many great options for just about everyone. If you're thinking of bettering your career prospects and know what you want to do after graduating, a T4U degree can significantly improve your job prospects at the same time as giving you professional skills and knowledge relevant to your future career.</p>
<p><strong>Flexible Learning Options</strong><br>At TERMINALFOUR University we recognise that University doesn’t necessarily involve several years of full-time study in one place. We want what will work best for you so we provide flexible study options let you choose how and when you learn. These include part-time study, distance and online learning and work-based learning.</p>
<p><strong>Personal development</strong><br>TERMINALFOUR University is interested in letting you develop as an individual. We give you time to develop new interests, to learn new skills and to meet lots of new people. If this is your first time away from home, you’ll become more independent and self-reliant.</p>
<p><strong>Valuable employability skills</strong><br>An increasing number of graduate jobs do not specify a particular subject area. The skills you will learn in your time at TERMINALFOUR University in the areas of information technology, communication skills, teamwork and problem solving will become invaluable in the search for employment after university.</p></div>
    
 <div class="prev-next">
    <a href="/alumni/news/2016/academic-quality-and-affordability-earn-terminalfour-university-recognition-in-international-rankings.php" >Next news story</a>
 </div>
