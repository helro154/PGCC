...
<!--[if (gt IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <head>
    ...
    <title>2016 - TERMINALFOUR University</title>
...
<div class="row">
	<div class="small-12 columns">
		    <nav class="breadcrumbs">
	            <ul><li><a href="/">Home</a></li><li><a href="/alumni/">Alumni</a></li><li><a href="/alumni/news/">News</a></li><li><a href="/alumni/news/2016/">2016</a></li></ul>
            </nav>
	</div>
</div>
<!-- ./breadcrumbs -->
...
<div class="row">
  <div class="snippet news-listing columns small-12">
    <a class="clearfix" href="/alumni/news/2016/why-terminalfour-university-this-is-more-than-just-an-education.php">
      ...
      <div class="snippet-text">
        <h2 class="h3 title">Why TERMINALFOUR University? This is more than just an education.</h2>
  ...
  <div class="snippet news-listing columns small-12">
    <a class="clearfix" href="/alumni/news/2016/academic-quality-and-affordability-earn-terminalfour-university-recognition-in-international-rankings.php">
      <div class="date-stamp">
        <div class="month">Sep
        </div>
        <div class="day">
      ...
      <div class="snippet-text">
        <h2 class="h3 title">Academic quality and affordability earn TERMINALFOUR University recognition in international rankings.</h2>
  ...
  <div class="snippet news-listing columns small-12">
    <a class="clearfix" href="/alumni/news/2016/terminalfour-university---a-home-away-from-home.php">
      <div class="date-stamp">
        <div class="month">Sep
        </div>
        <div class="day">
      ...
      <div class="snippet-text">
        <h2 class="h3 title">TERMINALFOUR University - A Home Away From Home</h2>
  ...
  <div class="snippet news-listing columns small-12">
    <a class="clearfix" href="/alumni/news/2016/get-ready-for-your-best-years---student-life-in-t4u.php">
      <div class="date-stamp">
        <div class="month">May
        </div>
        <div class="day">
      ...
      <div class="snippet-text">
        <h2 class="h3 title">Get ready for your best years - Student Life in T4U</h2>
