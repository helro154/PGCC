...
<!--[if (gt IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <head>
    ...
    <title>2016: Academic quality and affordability earn TERMINALFOUR University recognition in international rankings. - TERMINALFOUR University</title>
...
<div class="row">
	<div class="small-12 columns">
		    <nav class="breadcrumbs">
	            <ul><li><a href="/">Home</a></li><li><a href="/alumni/">Alumni</a></li><li><a href="/alumni/news/">News</a></li><li><a href="/alumni/news/2016/">2016</a></li><li>Academic quality and affordability earn TERMINALFOUR University recognition in international rankings.</li></ul>
            </nav>
	</div>
</div>
<!-- ./breadcrumbs -->
...
<!-- end of SM header -->
 ...
 <article class="news">
  <h1>Academic quality and affordability earn TERMINALFOUR University recognition in international rankings.</h1>
  <p class="meta">Published: <time datetime="2016-09-15">September 15, 2016</time></p>
   <p><strong>Tags:</strong> 
   <a href="/alumni/news/tagged/?tagged=<?php echo rawurlencode('T4U'); ?>">T4U</a><a href="/alumni/news/tagged/?tagged=<?php echo rawurlencode('TERMINALFOUR'); ?>">, TERMINALFOUR</a></p>
   
   <p class="intro">
   TERMINALFOUR University continues to be placed in a leading position by national and international college and university rankings for its strength of academic programs, student experience and overall value.
   </p>
   
   <div class="full_article"><p>TERMINALFOUR University was ranked No. 1 overall in the Best Universities category in the "World's Best Colleges" by a recent report. In the Forbes ranking of the nation's 650 best undergraduate institutions in, it ranked No.2.</p>
<p>TERMINALFOUR University is seen as the top school for its commitment to undergraduate teaching, and is recognized in other academic categories including its arts curriculum, the economic diversity of its student body and the outstanding opportunities for undergraduate students to participate in research. T4U topped the list for low student debt among all national universities.</p>
<p>T4U was the first university in the world to offer a comprehensive no-loan financial aid program that provides need-based aid in the form of grants, making it possible for students to graduate without debt. About 60 percent of T4U undergraduates receive grants, and the average grant for a student receiving aid this academic year is expected to be almost $53,000.</p>
<p>In international surveys, T4U was ranked in the top 10 among 1000 institutions across the globe by the World University Rankings.</p>
<p>"We are delighted that the University's outstanding academic quality and commitment to providing an affordable education continue to be recognized world over" T4U officials said.</p></div>
    
 <div class="prev-next">
    <a href="/alumni/news/2016/why-terminalfour-university-this-is-more-than-just-an-education.php" >Previous news story</a><a href="/alumni/news/2016/terminalfour-university---a-home-away-from-home.php" >Next news story</a>
 </div>


</article><!-- start of SM footer -->
  </div>
  ...
  <div class="small-12 medium-4 columns">
    ...
    <div class="h4 side-nav-header"><a href="/alumni/">Alumni</a></div>
       ...
       <ul class="side-nav">
      <li><a href="/alumni/events/">Events</a></li><li><span class="currentbranch0"><a href="/alumni/news/">News</a></span>
<ul class="multilevel-linkul-0">
<li><span class="currentbranch1"><a href="/alumni/news/2016/">2016</a></span></li>
<li><a href="/alumni/news/2015/">2015</a></li>
<li><a href="/alumni/news/2014/">2014</a></li>
    ...
    <!-- navigation object : News RSS feed link src="/media/sample-site/site-assets/images/footer-social-icons/rss-icon.png"  -->
<a class="rss-icon-link" href="/alumni/news/index.xml">
     <svg width="48" height="48">
          <image xlink:href="/media/sample-site/site-assets/images/footer-social-icons/rss-icon.svg" width="48" height="48"></image>
     </svg><span class="hidden">RSS</span>
</a>
