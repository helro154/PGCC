...
<!--[if (gt IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <head>
    ...
    <title>2014: A day in the life of a T4U student. What makes TERMINALFOUR U stand out? - TERMINALFOUR University</title>
...
<div class="row">
	<div class="small-12 columns">
		    <nav class="breadcrumbs">
	            <ul><li><a href="/">Home</a></li><li><a href="/alumni/">Alumni</a></li><li><a href="/alumni/news/">News</a></li><li><a href="/alumni/news/2014/">2014</a></li><li>A day in the life of a T4U student. What makes TERMINALFOUR U stand out?</li></ul>
            </nav>
	</div>
</div>
<!-- ./breadcrumbs -->
...
<!-- end of SM header -->
 ...
 <article class="news">
  <h1>A day in the life of a T4U student. What makes TERMINALFOUR U stand out?</h1>
  <p class="meta">Published: <time datetime="2014-11-10">November 10, 2014</time></p>
   <p><strong>Tags:</strong> 
   <a href="/alumni/news/tagged/?tagged=<?php echo rawurlencode('TERMINALFOUR'); ?>">TERMINALFOUR</a></p>
   ...
   <div class="full_article"><p><img src="/media/sample-site/content-assets/global-content-assets/images/news-images/leaves-300x300.jpg" alt="Fall image of leaves on the ground. Close Up." style="width : 300px; height : 300px;   margin : 0 1em 0;  float : left;" />Campus life will be a lot different to school, in a really good way. You'll have a much greater sense of responsibility and independence as your day to day life now involves classes, seminars, labs, practical work as well as independent study.</p>
<p>During your time here you'll have the wonderful opportunity to meet people from all over the world. As we see time and time again TERMINALFOUR University friends are friends for life.</p>
<p>Our ultra-modern health and fitness centre, just opened this year, has lots of classes and activities for you to take part in to keep your body active as your mind works out all day. It's home to many University sports clubs, as well as a salon and health spa. Why not try our our many classes in our spacious dance studio.</p>
<p>Our Students Union at TERMINALFOUR University was crowned 'University Student's Union of the Year 2014'. Run by students, for students, it is a hub for support and social activities. For support on your transition our team of students are available to chat at any time to take the stress of your everyday concerns. Struggling with budget or managing your time, talk to the best of TERMINALFOUR University to get you through it. Whatever the case, you can be assured of receiving the best expert advice.</p>
<p>These years are what you make of them, make them great.</p></div>
    
 <div class="prev-next">
    <a href="/alumni/news/2014/the-worlds-most-friendly-university-t4u-nominated.php" >Next news story</a>
 </div>
