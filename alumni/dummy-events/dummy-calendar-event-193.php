...
<!--[if (gt IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <head>
    ...
    <title>Dummy Events: Dummy Calendar Event 193 - TERMINALFOUR University</title>
...
<!--canonical-->
    ...
    <!-- start date -->
    <meta name="enddate" content="Sat, 09 Apr 2016 20:00:00 EDT" /><!-- end date -->
...
<div class="row">
	<div class="small-12 columns">
		    <nav class="breadcrumbs">
	            <ul><li><a href="/">Home</a></li><li><a href="/alumni/">Alumni</a></li><li><a href="/alumni/dummy-events/">Dummy Events</a></li><li>Dummy Calendar Event 193</li></ul>
            </nav>
	</div>
</div>
<!-- ./breadcrumbs -->
...
<article>
  <h1>Dummy Calendar Event 193</h1>
  <p class="meta">
<?php
try {
/* Version 0.1.126 */
  ...
  /* Start Catch */
    ...
    echo '<!--'.$e->getMessage().'-->';
    ?>
    <time class="sdate" datetime="2016-9-04">April 9, 2016</time><span class="to-date sr-only"> to <time datetime="2016-9-04">April 9, 2016</time></span> - <a href="#location-map">Dummy Event Plaza</a>
    <?php
}
/* End Catch */
?>
  </p>
  <p class="intro">This is a dummy description. Nisi neque officiis totam voluptatum tempore! Nisi in nulla sapiente.</p>

  <p>This is the main text for Dummy Calendar Event 193</p> 
<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto quasi commodi adipisci veritatis facilis assumenda velit blanditiis libero officia quos!</p> 
<p>Nostrum veritatis soluta sint repudiandae, cumque, earum voluptate aperiam sequi incidunt explicabo eveniet vitae deserunt. Illum magnam praesentium eius consequatur!</p> 
<p>Eos explicabo itaque perspiciatis suscipit nihil. Accusantium aliquid officiis quasi fuga dolores blanditiis, nisi commodi itaque excepturi tempore numquam eius.</p> 
<p>Minima deserunt doloribus odio libero eum commodi excepturi mollitia, odit animi consequuntur nobis, doloremque? Vero totam nobis officia, laborum culpa?</p>
...
<div class="ical">
    <a class="button btn btn-default calendar-button" href="<?php echo $t4_module['allevents']; ?>download.php?event_id=4380<?php echo isset($event_type) && !empty($event_type) ? '&event_type='.$event_type : ''; ?>">Download Event to Outlook</a>
</div>
<!-- start of SM footer -->
  </div>
