...
<!--[if (gt IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  ...
  <head>
    ...
    <title>Admissions - TERMINALFOUR University</title>
      <!-- Inner page left nav -->
...
<!-- End Google Tag Manager -->
    ...
    <meta name="description" content="To be accepted to study at TERMINALFOUR, all interested applicants must apply directly to the school, college, or program where the degree will be awarded. " /><!-- description -->
    <!-- keywords -->
    ...
    <meta property="og:description" content="To be accepted to study at TERMINALFOUR, all interested applicants must apply directly to the school, college, or program where the degree will be awarded. " /><!-- og:description -->
    <!-- og:image -->
    <meta property="og:type" content="article" /><meta property="og:url" content="https://samplesite.terminalfour.com/admissions/" /><meta property="og:title" content="Admissions" />
    ...
    <nav class="primary-nav top-bar" data-topbar data-options="sticky_on: large">
      ...
      <div class="top-bar-section">
        ...
        <ul class="left large-8 columns">
          <li><a href="/course-hub/">Course Hub</a></li><li><a href="/life-at-t4u/">Life at T4U</a></li><li><a href="/research/">Research</a></li><li><a href="/alumni/">Alumni</a></li><li><span class="currentbranch0"><a href="/admissions/">Admissions</a></span></li>
...
<div class="parallax parallax-small">
  <img data-interchange="[[/media/sample-site/content-assets/global-content-assets/images/parallax-images/brick-med.jpg,(medium)],[/media/sample-site/content-assets/global-content-assets/images/parallax-images/brick-lrg.jpg,(large)]," alt="Brick" src="/media/sample-site/content-assets/global-content-assets/images/parallax-images/brick-lrg.jpg" />
  <noscript>
    <img src="/media/sample-site/content-assets/global-content-assets/images/parallax-images/brick-lrg.jpg" alt="Brick" />
  </noscript>
...
<div class="row"><div class="small-12 columns">
  <nav class="breadcrumbs">
	<ul><li><a href="/">Home</a></li><li><a href="/admissions/">Admissions</a></li></ul>
  </nav>
</div>
</div>
  <!-- ./breadcrumbs -->    
...
<div class="general">
  ...
  <p class="intro">To be accepted to study at TERMINALFOUR, all interested applicants must apply directly to the school, college, or program where the degree will be awarded. </p>
  <div class="content"><p>Any applicant who wishes to apply for admission to the University of Florida must pay a non-refundable application fee. Any student that is admitted shall have this fee applied toward payment of that individual's tuition when they enroll.</p>
<h2>What do we look for</h2>
<p>The TERMINALFOUR University looks for students that are exceptionally bright, well-rounded and possess an unquenchable thirst for knowledge.</p>
<p>We want you to thrive at TERMINALFOUR University. Tell us who you are and what makes you different.</p>
<h3>What does this mean?</h3>
<p>There is no minimum GPA or test score</p>
<p>Your application will be reviewed multiple times and presented to an admissions committee</p>
<p>There is no one quality that we are looking for that will determine the strength of your application.</p></div>
</div><div class="general">
  
  
  <div class="content"><table>
<thead>
<tr><th scope="col">Column 1</th><th scope="col">Column 2</th><th scope="col">Column 3</th><th scope="col">Column 4</th><th scope="col">Column 5</th><th scope="col">Column 6</th></tr>
</thead>
<tbody>
<tr>
<td>Longer Table</td>
...
<td>Longer Table</td>
  ...
  <div class="small-12 medium-3 medium-pull-9 columns">
    <nav>
      <header>
    <div class="h4 side-nav-header"><a href="/admissions/">Admissions</a></div>
      </header>
    <ul class="side-nav">
      <li><a href="/admissions/admissions-process/">Admissions process</a></li><li><a href="/admissions/fees/">Fees</a></li>
    </ul>
    </nav>
